...
class PdfGenerateBestiuJob6
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			$VIII_SEM=trim($studentData[354]);
			$SEM8_COURSE_CODE_1=trim($studentData[355]);
			$SEM8_COURSE_TITLE_1=trim($studentData[356]);
			$SEM8_CREDIT_HOURS_1=trim($studentData[357]);
			$SEM8_GRADE_POINT_1=trim($studentData[358]);
			$SEM8_CREDIT_POINTS_1=trim($studentData[359]);
			$SEM8_COURSE_CODE_2=trim($studentData[360]);
			$SEM8_COURSE_TITLE_2=trim($studentData[361]);
			$SEM8_CREDIT_HOURS_2=trim($studentData[362]);
			$SEM8_GRADE_POINT_2=trim($studentData[363]);
			$SEM8_CREDIT_POINTS_2=trim($studentData[364]);
			$TOTAL_CREDITS_CREDIT_HOURS=trim($studentData[365]);
			$TOTAL_CREDITS_CREDIT_POINTS=trim($studentData[366]);
			$OVERALL_GRADE_POINT_AVERAGE=trim($studentData[367]);
			$DATE=trim($studentData[368]);
			$Photo=trim($studentData[369]);
