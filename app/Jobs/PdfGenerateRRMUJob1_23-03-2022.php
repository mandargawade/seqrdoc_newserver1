...
class PdfGenerateRRMUJob1
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) 
        {
            ...
            $pdfBig->SetXY($x, $y);
            $pdfBig->Cell(0, 0, 'It is certify that', 0, false, 'C');
            ...
            $pdfBig->SetFont($times, '', 16, '', false);
            $pdfBig->SetXY($x, $y);
            $pdfBig->Cell(0, 0, 'Degree Examination the year.......................', 0, false, 'C');
            ...
            if(strtoupper($studentData[8]) == 'SECOND'){
                ...
                $pdf->SetFont($times, '', 16, '', false);
                $pdf->SetXY($x, $y);
                $pdf->Cell(0, 0, 'He/She is the '.$studentData[8].' topper in the above said complete degree examination.', 0, false, 'C');

                $pdfBig->SetTextColor(62,64,149);   
                $pdfBig->SetFont($times, '', 16, '', false);
                $pdfBig->SetXY($x, $y);
                $pdfBig->Cell(0, 0, 'He/She is the '.$studentData[8].' topper in the above said complete degree examination.', 0, false, 'C');
            }else{
                $x = 10;
                $y = 178.5; //179
                $pdf->SetTextColor(62,64,149);   
                ...
                $pdfBig->SetFont($times, '', 16, '', false);
                $pdfBig->SetXY($x, $y);
                $pdfBig->Cell(0, 0, 'He/She is the topper in the above said complete degree examination.', 0, false, 'C');
            }
            ...
            $pdf->SetFont($times, '', 16, '', false);
            $pdf->SetXY($x, $y);
            $pdf->Cell(0, 0, 'is the '.$studentData[8].' rank holder among all the students of all the', 0, false, 'C');

            $pdfBig->SetTextColor(62,64,149);   
            $pdfBig->SetFont($times, '', 16, '', false);
            $pdfBig->SetXY($x, $y);
            $pdfBig->Cell(0, 0, 'is the '.$studentData[8].' rank holder among all the students of all the', 0, false, 'C');
            ...
            $pdfBig->SetFont($times, '', 16, '', false);
            $pdfBig->SetXY($x, $y);
            $pdfBig->Cell(0, 0, 'constituent colleges of the University.', 0, false, 'C');
            ...
            $pdfBig->SetFont($times, '', 16, '', false);
            $pdfBig->SetXY($x, $y);
            $pdfBig->Cell(0, 0, 'the course with in the stipulated time.', 0, false, 'C');
