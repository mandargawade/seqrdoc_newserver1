...
class PdfGenerateSangamuniDHAJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
            ...
            $cgpa = $studentData[8];
            $division = $studentData[9];
            $date = \PhpOffice\PhpSpreadsheet\Shared\Date::excelToDateTimeObject($studentData[10])->format('jS F, Y');
   ...
   //          $pdfBig->MultiCell(27, 0, trim($print_serial_no), 0, 'C', 0, 0);
            ...
            $pdfBig->SetFont('Clearface', '', 18, '', false); 
            $pdfBig->setXY(10, 209);
            $pdfBig->MultiCell(186, 4, "in ". $year." with ".$division." Division\nand awarded the Diploma on ".$date."\nunder the seal of the Sangam University, Bhilwara", '', 'C', 0, 1);
   ...
   //          $pdf->MultiCell(27, 0, trim($print_serial_no), 0, 'C', 0, 0);
            ...
            $pdf->SetFont('Clearface', '', 18, '', false); 
            $pdf->setXY(10, 209);
            $pdf->MultiCell(186, 4, "in ". $year." with ".$division." Division\nand awarded the Diploma on ".$date."\nunder the seal of the Sangam University, Bhilwara", '', 'C', 0, 1);
