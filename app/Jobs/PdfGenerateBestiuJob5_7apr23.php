...
class PdfGenerateBestiuJob5
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			$pdfBig->Cell(12, 89, '', 1, false, 'L');
			$pdfBig->Cell(17, 89, '', 1, false, 'L');
			$pdfBig->Cell(105.5, 89, '', 1, false, 'L');
			$pdfBig->Cell(16.9, 89, '', 1, false, 'L');
			$pdfBig->Cell(17, 89, '', 1, false, 'L');
			$pdfBig->Cell(16.9, 89, '', 1, false, 'L');
            ...
            foreach ($subjectsArr as $subjectData){
				...
				if($courseCode != ''){		
					...
					$pdfBig->MultiCell(13, 10, $sr, 0, 'C', 0, 0);
				}
				$pdfBig->SetXY(25, $subj_y);
                $pdfBig->MultiCell(18, 10, $courseCode, 0, 'L', 0, 0);
                $pdfBig->SetXY(42, $subj_y);
                $pdfBig->MultiCell(105.5, 10, $Course_Name, 0, 'L', 0, 0);
                $pdfBig->SetXY(146.5, $subj_y);
                $pdfBig->MultiCell(17, 10, $Credit_Hours, 0, 'C', 0, 0);     
                $pdfBig->MultiCell(17, 10, $Grade_Point, 0, 'C', 0, 0);     
                $pdfBig->MultiCell(17, 10, $Credit_Points, 0, 'C', 0, 0); 
                $subj_y=$subj_y+7.3;
            }
            ...
            $pdfBig->SetXY(12.5, 170);
            $pdfBig->MultiCell(185.3, 9, '               SUPPLEMENTARY EXAMINATIONS', 'LR', 'L', 0, 0);
            $pdfBig->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
            $pdfBig->SetXY($left_pos, 179);
			$pdfBig->Cell(12, 31, '', 1, false, 'L');
			$pdfBig->Cell(17, 31, '', 1, false, 'L');
			$pdfBig->Cell(105.5, 31, '', 1, false, 'L');
			$pdfBig->Cell(16.9, 31, '', 1, false, 'L');
			$pdfBig->Cell(17, 31, '', 1, false, 'L');
			$pdfBig->Cell(16.9, 31, '', 1, false, 'L');
            ...
            foreach ($subjectsArr as $subjectSEData){
                ...
                {
					$pdfBig->SetXY(12, $subj_y);
					$pdfBig->MultiCell(13, 9, $sr, 0, 'C', 0, 0);
					$pdfBig->SetXY(25, $subj_y);
	                $pdfBig->MultiCell(18, 9, $courseCode, 0, 'L', 0, 0);
	                $pdfBig->SetXY(42, $subj_y);
	                $pdfBig->MultiCell(105.5, 9, $Course_Name, 0, 'L', 0, 0);
	                $pdfBig->SetXY(146.5, $subj_y);
	                $pdfBig->MultiCell(17, 9, $Credit_Hours, 0, 'C', 0, 0);     
	                $pdfBig->MultiCell(17, 9, $Grade_Point, 0, 'C', 0, 0);     
	                $pdfBig->MultiCell(17, 9, $Credit_Points, 0, 'C', 0, 0); 
	                $subj_y=$subj_y+6.3;
	            }
            }
			...
			$pdf->Cell(12, 89, '', 1, false, 'L');
			$pdf->Cell(17, 89, '', 1, false, 'L');
			$pdf->Cell(105.5, 89, '', 1, false, 'L');
			$pdf->Cell(16.9, 89, '', 1, false, 'L');
			$pdf->Cell(17, 89, '', 1, false, 'L');
			$pdf->Cell(16.9, 89, '', 1, false, 'L');
            ...
            foreach ($subjectsArr as $subjectData){
				...
				if($courseCode != ''){	
					$pdf->SetXY(12, $subj_y);
					$pdf->MultiCell(13, 10, $sr, 0, 'C', 0, 0);
				}
				$pdf->SetXY(25, $subj_y);
                $pdf->MultiCell(18, 10, $courseCode, 0, 'L', 0, 0);
                $pdf->SetXY(42, $subj_y);
                $pdf->MultiCell(105.5, 10, $Course_Name, 0, 'L', 0, 0);
                $pdf->SetXY(146.5, $subj_y);
                $pdf->MultiCell(17, 10, $Credit_Hours, 0, 'C', 0, 0);     
                $pdf->MultiCell(17, 10, $Grade_Point, 0, 'C', 0, 0);     
                $pdf->MultiCell(17, 10, $Credit_Points, 0, 'C', 0, 0); 
                $subj_y=$subj_y+7.3;
            }
            ...
            $pdf->SetXY($left_pos, 179);
			$pdf->Cell(12, 31, '', 1, false, 'L');
			$pdf->Cell(17, 31, '', 1, false, 'L');
			$pdf->Cell(105.5, 31, '', 1, false, 'L');
			$pdf->Cell(16.9, 31, '', 1, false, 'L');
			$pdf->Cell(17, 31, '', 1, false, 'L');
			$pdf->Cell(16.9, 31, '', 1, false, 'L');
            ...
            foreach ($subjectsArr as $subjectSEData){
                ...
                {
					$pdf->SetXY(12, $subj_y);
					$pdf->MultiCell(13, 9, $sr, 0, 'C', 0, 0);
					$pdf->SetXY(25, $subj_y);
	                $pdf->MultiCell(18, 9, $courseCode, 0, 'L', 0, 0);
	                $pdf->SetXY(42, $subj_y);
	                $pdf->MultiCell(105.5, 9, $Course_Name, 0, 'L', 0, 0);
	                $pdf->SetXY(146.5, $subj_y);
	                $pdf->MultiCell(17, 9, $Credit_Hours, 0, 'C', 0, 0);     
	                $pdf->MultiCell(17, 9, $Grade_Point, 0, 'C', 0, 0);     
	                $pdf->MultiCell(17, 9, $Credit_Points, 0, 'C', 0, 0); 
	                $subj_y=$subj_y+6.3;
	            }
            }
