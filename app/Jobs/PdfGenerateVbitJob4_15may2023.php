    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			foreach ($reg_nos as $key => $value){
                ...
                $pdf->MultiCell(9, 11, $Sr_No, 0, 'L', 0, 0);
                $pdf->SetXY(26.5, $subj_y);
                $pdf->MultiCell(23.5, 11, $Subject_Code,0, 'L', 0, 0);
                ...
                $pdfBig->MultiCell(9, 11, $Sr_No, 0, 'L', 0, 0);
                $pdfBig->SetXY(26.5, $subj_y);
                $pdfBig->MultiCell(23.5, 11, $Subject_Code,0, 'L', 0, 0);
