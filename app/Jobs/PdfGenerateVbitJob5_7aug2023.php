...
class PdfGenerateVbitJob5
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
            ...
            $pdf->SetXY(92, 38);
			$pdf->writeHTML('<u>'.$Certificate.'</u>', true, 0, true, 0);
			...
			$pdf->SetFont($times, '', 13.5, '', false);
            $pdf->SetXY(89, 123.5);
			$pdf->MultiCell(94, 0, $candidate_name,'B', 'L', 0, 0, '', '', true, 0, true);
			...
			$pdf->SetFont($times, '', 13.5, '', false);
            $pdf->SetXY(65, 137.5);
			$pdf->MultiCell(118, 0, $Parents_Name,'B', 'L', 0, 0, '', '', true, 0, true);
			...
			$pdf->SetFont($times, '', 13.5, '', false);
            $pdf->SetXY(41, 151.5);
			$pdf->MultiCell(127, 0, $Degree,'B', 'L', 0, 0, '', '', true, 0, true);
			$pdf->SetFont($times, '', 15, '', false);
			$pdf->SetXY(169, 151);
			...
			$pdf->SetFont($times, '', 15, '', false);
			$pdf->SetXY(25, 166);
			$pdf->MultiCell(0, 0, 'examination of this college (Autonomous) affiliated to JNTUH, Hyderabad,',0, 'L', 0, 0, '', '', true, 0, true);
			...
			$pdf->SetFont($times, '', 13.5, '', false);
            $pdf->SetXY(42, 179.5);
			$pdf->MultiCell(74, 0, $Year,'B', 'C', 0, 0, '', '', true, 0, true);
			$pdf->SetFont($times, '', 15, '', false);
			$pdf->SetXY(118, 179.5);
			...
			$pdf->SetFont($times, '', 13.5, '', false);
            $pdf->SetXY(26, 194);
			$pdf->MultiCell(158, 0, $Placed_in,'B', 'C', 0, 0, '', '', true, 0, true);
			
			$pdf->SetFont($times, '', 15, '', false);
            $pdf->SetXY(25, 208);
			$pdf->MultiCell(161, 0, 'He / She has satisfied all the requirements for the award of the degree.',0, 'C', 0, 0, '', '', true, 0, true);
            ...
            $pdfBig->SetXY(92, 38);
			$pdfBig->writeHTML('<u>'.$Certificate.'</u>', true, 0, true, 0);
			...
			$pdfBig->SetFont($times, '', 13.5, '', false);
            $pdfBig->SetXY(89, 123.5);
			$pdfBig->MultiCell(94, 0, $candidate_name,'B', 'L', 0, 0, '', '', true, 0, true);
			
			$pdfBig->SetFont($times, '', 15, '', false);
			$pdfBig->SetXY(25, 137);
			$pdfBig->MultiCell(45, 0, 'Son / Daughter of',0, 'L', 0, 0, '', '', true, 0, true);
			$pdfBig->SetFont($times, '', 13.5, '', false);
            $pdfBig->SetXY(65, 137.5);
			$pdfBig->MultiCell(118, 0, $Parents_Name,'B', 'L', 0, 0, '', '', true, 0, true);
			
			$pdfBig->SetFont($times, '', 15, '', false);
			$pdfBig->SetXY(25, 151);
			$pdfBig->MultiCell(30, 0, 'Passed',0, 'L', 0, 0, '', '', true, 0, true);
			$pdfBig->SetFont($times, '', 13.5, '', false);
            $pdfBig->SetXY(41, 151.5);
			$pdfBig->MultiCell(127, 0, $Degree,'B', 'L', 0, 0, '', '', true, 0, true);
			$pdfBig->SetFont($times, '', 15, '', false);
			...
			$pdfBig->SetFont($times, '', 15, '', false);
			$pdfBig->SetXY(25, 166);
			$pdfBig->MultiCell(0, 0, 'examination of this college (Autonomous) affiliated to JNTUH, Hyderabad,',0, 'L', 0, 0, '', '', true, 0, true);
			
			$pdfBig->SetFont($times, '', 15, '', false);
			$pdfBig->SetXY(25, 179.5);
			$pdfBig->MultiCell(0, 0, 'held in',0, 'L', 0, 0, '', '', true, 0, true);
			$pdfBig->SetFont($times, '', 13.5, '', false);
            $pdfBig->SetXY(42, 179.5);
			$pdfBig->MultiCell(74, 0, $Year,'B', 'C', 0, 0, '', '', true, 0, true);
			$pdfBig->SetFont($times, '', 15, '', false);
			$pdfBig->SetXY(118, 179.5);
			$pdfBig->MultiCell(0, 0, 'and that he / she was placed in',0, 'L', 0, 0, '', '', true, 0, true);
			
			$pdfBig->SetFont($times, '', 13.5, '', false);
            $pdfBig->SetXY(26, 194);
			$pdfBig->MultiCell(158, 0, $Placed_in,'B', 'C', 0, 0, '', '', true, 0, true);
			
			$pdfBig->SetFont($times, '', 15, '', false);
            $pdfBig->SetXY(25, 208);
			$pdfBig->MultiCell(161, 0, 'He / She has satisfied all the requirements for the award of the degree.',0, 'C', 0, 0, '', '', true, 0, true);
