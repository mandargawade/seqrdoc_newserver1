...
class PdfGenerateBiharEstampEcourtUtilityJob
{
            ...
            // }
                ...
                $mergePath="C:/Inetpub/vhosts/seqrdoc.com/httpdocs/demo/public/estamp/backend/tcpdf/examples/preview/";    
                 ...
                 if(!empty($bg_pdf_file)){
                    $bgPath="C:/Inetpub/vhosts/seqrdoc.com/httpdocs/demo/public/estamp/backend/templates/100/".$bg_pdf_file;
                }else{
                ...
                if($template_printer_name=="HP403"){
