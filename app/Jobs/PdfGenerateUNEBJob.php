...
class PdfGenerateUNEBJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
       ...
       // $pdfBig->AddSpotColor('Spot Light Yellow', 0, 0, 100, 0);
        ...
        $universeItalic = TCPDF_FONTS::addTTFfont(public_path().'\\'.$subdomain[0].'\backend\canvas\fonts\Univers55Italic.ttf', 'TrueTypeUnicode', '', 96);
        ...
        foreach ($studentDataOrg as $studentData) {
            ...
            $low_res_bg_verification="uneb_bg_LVR_verification.jpg";
         ...
         //
           // echo $date = \PhpOffice\PhpSpreadsheet\Shared\Date::excelToDateTimeObject($studentData[9])->format('d-m-Y');//31
            ...
            //exit;
            $dateFormat=explode('-',$studentData[9]);
            //print_r($dateFormat);
...
*/
            ...
            $pdfBig->SetTextColor(0, 0, 0, $opacityStatic);
            $pdfBig->setXY(17, 26);
            $pdfBig->MultiCell(41, 0, "Our Reference:", '', 'L', 0, 1);

            $pdfBig->SetFont($courierNewBold, '', 11, '', false);
            $pdfBig->setXY(54, 26.5);
            $pdfBig->SetTextColor(0, 0, 0, 100);
            $pdfBig->MultiCell(41, 0, 'EA/GEN/40', '', 'L', 0, 1);
            ...
            $pdfBig->SetTextColor(0, 0, 0, $opacityStatic);
            $pdfBig->setXY(130, 24);
            $pdfBig->MultiCell(150, 0, 'P.O. Box 7066', '', 'L', 0, 1);//$centreAddress
            ...
            $pdfBig->SetOverprint(true, true, 0);
            $pdfBig->SetFont($courierNewBold, 'B', 11, '', false);
            $pdfBig->SetTextSpotColor('Special', 100);
            $pdfBig->SetXY(168, 207);
            $pdfBig->Rotate(90);
            ...
            $pdfBig->SetFont($courierNewBold, 'B', 11, '', false);
            $pdfBig->SetTextSpotColor('Special', 100);
            $pdfBig->SetXY(173, 207);
            $pdfBig->Rotate(90);
            $pdfBig->MultiCell(100, 0, $indexNo, '', 'L', 0, 1);
            $pdfBig->Rotate(0);
            $pdfBig->SetTextColor(0, 0, 0, 100);
            $pdfBig->SetOverprint(false, false, 0);
            $pdfBig->StopTransform();
           ...
           /* $pdfBig->setXY(17, 138);
            ...
            $pdfBig->SetFont($universe, '', 12.5, '', false);
            $pdfBig->setXY(45, 148.5);
            $pdfBig->MultiCell(75, 0, '______________', '', 'L', 0, 1);
            ...
            $pdfBig->SetFont($universe, '', 12.5, '', false);
            $pdfBig->setXY(125, 148.5);
            $pdfBig->MultiCell(169, 0, '______________', '', 'L', 0, 1);
            ...
            $pdfBig->SetFont($courierNewBold, 'B', 11, '', false);
            $pdfBig->SetTextSpotColor('Special', 100);
            $pdfBig->setXY(57+6, 212);
            $pdfBig->MultiCell(30, 0, $subjectCount, '', 'L', 0, 1);
            $pdfBig->SetTextColor(0,0,0,100);
            $pdfBig->SetOverprint(false, false, 0);*/
            /********INVISIBLE END****/
            ...
            $pdfBig->SetFont($courierNewBold, 'B', 11, '', false);
            $pdfBig->SetTextSpotColor('Special', 100);
            $pdfBig->setXY(130+8, 212);
            $pdfBig->MultiCell(27, 0, $aggregate, '', 'L', 0, 1);
            $pdfBig->SetTextColor(0,0,0,100);
            $pdfBig->SetOverprint(false, false, 0);*/
            /********INVISIBLE END****/
            ...
            $pdfBig->SetFont($courierNewBold, 'B', 11, '', false);
            $pdfBig->SetTextSpotColor('Special', 100);
            $pdfBig->setXY(174+3.5, 212);
            $pdfBig->MultiCell(15, 0, $resultFinal, '', 'L', 0, 1);
            $pdfBig->SetTextColor(0,0,0,100);
            $pdfBig->SetOverprint(false, false, 0);*/
            /********INVISIBLE END****/
            ...
            $pdfBig->SetFont($courierNewBold, '', 11, '', false);
            $pdfBig->setXY(43, 249.5);
            $pdfBig->SetTextColor(0, 0, 0, 100);
            $pdfBig->MultiCell(77, 0, 'Dan N. Odongo', '', 'L', 0, 1);
            ...
            $pdfBig->SetFont($universeItalic, 'I', 12, '', false);
            $pdfBig->setXY(17, 254);
            $pdfBig->MultiCell(77, 0, 'Secretary', '', 'C', 0, 1);

            

            $pdfBig->write2DBarcode($codeContents, 'QRCODE,Q', $qrCodex, $qrCodey+3, $qrCodeWidth, $qrCodeHeight, $style1D, 'N');

            $pdfBig->SetFont('Arial', '', 1.5, '', false);//1.2
            $pdfBig->setXY(133, 264);//258
            $pdfBig->MultiCell(19, 0, trim($candidateName).' GA '.$aggregate, '', 'C', 0, 1);

            
            $pdfBig->Image("$tmpDir/" . $name."".$ghost_font_size.".png", $ghostImagex, $ghostImagey+4.5, $w, $ghostImageHeight, "PNG", '', 'C', true, 3600);
            ...
            $pdf->SetTextColor(0, 0, 0, $opacityStatic);
            ...
            $pdf->setXY(54, 26.5);
            $pdf->SetTextColor(0, 0, 0, 100);
            $pdf->MultiCell(41, 0, 'EA/GEN/40', '', 'L', 0, 1);
            ...
            $pdf->setXY(130, 24);
            $pdf->MultiCell(150, 0, 'P.O. Box 7066', '', 'L', 0, 1);
            ...
            $pdf->StartTransform();
            $pdf->SetOverprint(true, true, 0);
            $pdf->SetFont($courierNewBold, 'B', 11, '', false);
            ...
            $pdf->SetXY(173, 207);
            $pdf->Rotate(90);
            $pdf->MultiCell(100, 0, $indexNo, '', 'L', 0, 1);
            $pdf->Rotate(0);
            $pdf->SetTextColor(0,0,0,100);
            $pdf->SetOverprint(false, false, 0);
            $pdf->StopTransform();
            ...
            $pdf->SetFont($universe, '', 12.5, '', false);
            $pdf->setXY(125, 148.5);
            $pdf->MultiCell(169, 0, '______________', '', 'L', 0, 1);
            ...
            $pdf->SetTextSpotColor('Special', 100);
            $pdf->setXY(57+6, 212);
            $pdf->MultiCell(30, 0, $subjectCount, '', 'L', 0, 1);
            $pdf->SetTextColor(0,0,0,100);
            $pdf->SetOverprint(false, false, 0);*/
            /********INVISIBLE END****/
            ...
            $pdf->SetFont($courierNewBold, 'B', 11, '', false);
            $pdf->SetTextSpotColor('Special', 100);
            $pdf->setXY(128+10, 212);
            $pdf->MultiCell(27, 0, $aggregate, '', 'L', 0, 1);
            $pdf->SetTextColor(0,0,0,100);
            $pdf->SetOverprint(false, false, 0);*/
            /********INVISIBLE END****/
            ...
            $pdf->SetFont($courierNewBold, 'B', 11, '', false);
            $pdf->SetTextSpotColor('Special', 100);
            $pdf->setXY(172+5.5, 212);
            $pdf->MultiCell(15, 0, $resultFinal, '', 'L', 0, 1);
            $pdf->SetTextColor(0,0,0,100);
            $pdf->SetOverprint(false, false, 0);*/
            /********INVISIBLE END****/
            ...
            $pdf->setXY(43, 249.5);
            $pdf->SetTextColor(0, 0, 0, 100);
            $pdf->MultiCell(77, 0, 'Dan N. Odongo', '', 'L', 0, 1);

            $pdf->SetFont($universe, '', 12, '', false);
            $pdf->setXY(17, 250);
            $pdf->MultiCell(77, 0, '...........................................................', '', 'L', 0, 1);

            $pdf->SetFont($universeItalic, 'I', 12, '', false);
            $pdf->setXY(17, 254);
            ...
            $pdf->Image($sign_secretary, 18, 231.5, '72', '20', "PNG", '', 'R', true);
