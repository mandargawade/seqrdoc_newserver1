            ...
            if($term < 4)
            {
                ...
                if($term == 1){
                    $strtd .=   '<tr>
                                ...
                                <td style="width:58%;text-align:left;" colspan="2"><B>Credits : '.round($studentData[$IndividualDataIndex],2).'</B></td>
                                <td style="width:7%;text-align:center;"><B></B></td>
                                <td style="width:6%;text-align:center;"><B></B></td>
                                <td style="width:19%;text-align:center;border-right:0px solid black;"><B>GPA : '.round($studentData[$GpaIndex],2).'</B></td>
                            </tr>';
                    $IndividualDataIndex++;         
                    $GpaIndex+=2;         
                }else{
                    $strtd .=   '<tr>
                                    <td style="width:10%;text-align:center;border-right:0px solid black;border-left:0px solid black;"><B></B></td>
                                    <td style="width:58%;text-align:left;" colspan="2"><B>Credits : '.round($studentData[$IndividualDataIndex+1],2).'</B></td>
                                    <td style="width:7%;text-align:center;"><B></B></td>
                                    <td style="width:6%;text-align:center;"><B></B></td>
                                    <td style="width:19%;text-align:center;border-right:0px solid black;"><B>GPA : '.round($studentData[$GpaIndex],2).'</B></td>
                                </tr>';
                    ...
                    if($term == 3){
						...
						$strtd .=   '<tr>
									<td style="width:10%;text-align:center;border-right:0px solid black;border-left:0px solid black;"><B></B></td>
									<td style="width:58%;text-align:left;" colspan="2"><B>Credits : '.round($TC_7,2).'</B></td>
									<td style="width:7%;text-align:center;"><B></B></td>
									<td style="width:6%;text-align:center;"><B></B></td>
                ...
                if($term == 4){    
					$strtr .=   '<tr>
                                    ...
                                    <td style="width:7%;text-align:center;"><B></B></td>
                                    <td style="width:6%;text-align:center;"><B></B></td>
                                    <td style="width:19%;text-align:center;"><B>GPA : '.round($studentData[$GpaIndex],2).'</B></td>
                                </tr>';
					$IndividualDataIndex++;
                    $GpaIndex+=2;			
                }else{
					...
					$strtr .=   '<tr>
                                    <td style="width:10%;text-align:center;"><B></B></td>
                                    <td style="width:58%;text-align:left;" colspan="2"><B>Credits : '.round($studentData[$IndividualDataIndex+2],2).'</B></td>
                                    <td style="width:7%;text-align:center;"><B></B></td>
                                    <td style="width:6%;text-align:center;"><B></B></td>
                                    <td style="width:19%;text-align:center;"><B>GPA : '.round($studentData[$GpaIndex],2).'</B></td>
                                </tr>';
