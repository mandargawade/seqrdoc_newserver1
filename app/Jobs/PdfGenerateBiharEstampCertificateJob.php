...
class PdfGenerateBiharEstampCertificateJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        // foreach ($studentDataOrg as $studentData) {
            ...
            // }
               ...
               /* }else{
                ...
                $pdfBig->Image($tmpDir, $ghostImagex, $ghostImagey, $ghostImageWidth, $ghostImageHeight, "PNG", '', 'C', true, 3600);
       ...
       //$filename = public_path().'/backend/tcpdf/examples/'.$file_name;
        ...
        #Python script for merging background pdf  
        $pyscript = $directoryUrlBackward."Python_files\\estamp_merge_compress.py";//estamp_merge_compress
        $cmd = "$pyscript $file_name $file_name $mergePath $bgPath 2>&1"; // 
        exec($cmd, $output, $return);
        //End of python script
...
public function addPrintDetails($username, $print_datetime, $printer_name, $printer_count, $print_serial_no, $sr_no,$template_name,$admin_id,$card_serial_no)
    ...
    public function createTemp($path){
        ...
        //$tmp = $sixDigitRandomNumber.$certificateno.date("YmdHis");
