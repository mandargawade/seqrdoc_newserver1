...
class PdfGenerateSdmNursingJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			$pdfBig->SetXY(25, 102);
			$pdfBig->MultiCell(71.5, 5, 'SUBJECT', 0, 'C', 0, 0);
			$pdfBig->SetXY(96, 98);
			...
			$pdf->SetXY(24.5, 97);	
			$pdf->MultiCell(71.5, 13, '', 'LR', 'C', 0, 0);  //Subject
			...
			$pdf->SetXY(25, 102);
			$pdf->MultiCell(71.5, 5, 'SUBJECT', 0, 'C', 0, 0);
			$pdf->SetXY(96, 98);
			...
			foreach ($subjectsArr as $subjectDatas){
				...
				$lines = $pdfBig->MultiCell(71.5, 0, $Subject_Name, 0, 'L', 0, 0, '', '', true, 0, false,true, 0);
				...
				$pdf->SetFont($MyriadProRegular, '', 10, '', false);					
					...
					$pdfBig->MultiCell(71.5, $th_height, $Subject_Name, 'LR', 'L', 0, 0);					
					$pdfBig->SetXY(96, $subj_y);
					
					$pdf->SetXY($left_str_x, $subj_y);
					$pdf->MultiCell(9.5, $th_height, $Sr_no, 'LR', 'C', 0, 0);
					$pdf->MultiCell(71.5, $th_height, $Subject_Name, 'LR', 'L', 0, 0);					
					$pdf->SetXY(96, $subj_y);
					...
					$pdfBig->MultiCell(18, $th_height_half, $Remark, 'LR', 'C', 0, 0);
					...
					$pdf->MultiCell(20, $th_height_half, $Remark, 'LR', 'C', 0, 0);
			...
			$pdfBig->SetXY($left_str_x, $subj_y);	
			$pdfBig->MultiCell(135, 5, 'GRAND TOTAL:', 'LTRB', 'R', 0, 0); 
			$pdfBig->SetFont($MyriadProRegular, '', 10, '', false);
			...
			*/
			...
			$pdf->SetXY($left_str_x, $subj_y);	
			$pdf->MultiCell(134, 5, 'GRAND TOTAL:', 'LTRB', 'R', 0, 0); 
			$pdf->SetFont($MyriadProRegular, '', 10, '', false);
