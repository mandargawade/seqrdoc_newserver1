...
class pdfGenerateSdmBscNursingJob{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
            ...
            $pdfBig->SetXY($left_str_x, $subj_y);	
			$pdfBig->MultiCell(134.8, 5, 'SGPA', 'LR', 'R', 0, 0); 
			$pdfBig->MultiCell(45.8, 5, $sgpa, 'R', 'L', 0, 0);
			$pdfBig->SetXY($left_str_x, $subj_y+5);	
			$pdfBig->MultiCell(134.8, 5, 'CGPA', 'LR', 'R', 0, 0); 
			$pdfBig->MultiCell(45.8, 5,$cgpa, 'R', 'L', 0, 0);
			$pdfBig->SetXY($left_str_x, $subj_y+10);	
			$pdfBig->MultiCell(134.8, 5, 'CLASS:', 'LRB', 'R', 0, 0); 
			$pdfBig->MultiCell(45.8, 5, $class_grade, 'LRB', 'L', 0, 0); 

            $pdf->SetFont($MyriadProBold, 'B', 10, '', false);
            $pdf->SetXY($left_str_x, $subj_y);	
			$pdf->MultiCell(134.8, 5, 'SGPA', 'LR', 'R', 0, 0); 
			$pdf->MultiCell(45.8, 5, $sgpa, 'R', 'L', 0, 0);
			$pdf->SetXY($left_str_x, $subj_y+5);	
			$pdf->MultiCell(134.8, 5, 'CGPA', 'LR', 'R', 0, 0); 
			$pdf->MultiCell(45.8, 5,$cgpa, 'R', 'L', 0, 0);
			$pdf->SetXY($left_str_x, $subj_y+10);	
			$pdf->MultiCell(134.8, 5, 'CLASS:', 'LRB', 'R', 0, 0); 
			$pdf->MultiCell(45.8, 5, $class_grade, 'LRB', 'L', 0, 0); 
			...
			$pdfBig->MultiCell(18,  8.2, 'PERCENTAGE OF MARKS', 1, 'R', 0, 0);
			...
			$pdfBig->MultiCell(18, 8.2, 'LETTER GRADE', 1, 'R', 0, 0);
			...
			$pdfBig->MultiCell(18, 8.2, 'GRADE POINT', 1, 'R', 0, 0);
			...
			$pdfBig->MultiCell(18, 8.2, 'REMARKS', 1, 'R', 0, 0);
			...
			$pdf->MultiCell(18,  8.2, 'PERCENTAGE OF MARKS', 1, 'R', 0, 0);
