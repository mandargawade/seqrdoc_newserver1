...
class PdfGenerateUNEBECOEJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        for($dataIndex=0;$dataIndex<count($studentDataOrg);$dataIndex++){
            ...
            $uniqueNo = str_replace('/', '_', $indexNo).'_'.$examYear;
           ...
           // echo $date = \PhpOffice\PhpSpreadsheet\Shared\Date::excelToDateTimeObject($studentData[9])->format('d-m-Y');//31
            ...
            for($i=1;$i<=10;$i++)
            {
                ...
                if($subject != "")
                {
                    ...
                    $pdfBig->MultiCell(169, 0, '1  '.strtoupper($subject), '', 'L', 0, 1);
            ...
            $pdfBig->MultiCell(19, 0, $candidateName, '', 'C', 0, 1);
            ...
            for($i=1;$i<=10;$i++)
            {
                ...
                if($subject != "")
                {
                    ...
                    $pdf->MultiCell(169, 0, '1  '.strtoupper($subject), '', 'L', 0, 1);
            ...
            $pdf->setXY(10, 33);//258
            $pdf->MultiCell(19, 0, $candidateName, '', 'C', 0, 1);
    ...
    public generateVerificationPdf(){
