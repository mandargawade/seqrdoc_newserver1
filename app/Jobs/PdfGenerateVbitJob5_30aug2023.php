...
class PdfGenerateVbitJob5
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
            ...
            $pdf->SetXY(82, 123.3);
			$pdf->MultiCell(114, 0, $candidate_name,'B', 'L', 0, 0, '', '', true, 0, true);
			...
			$pdf->SetFont($times, '', 13, '', false);
            $pdf->SetXY(58, 137.3);
			$pdf->MultiCell(138, 0, $Parents_Name,'B', 'L', 0, 0, '', '', true, 0, true);
			...
			$pdf->SetFont($times, '', 13, '', false);
            $pdf->SetXY(35, 179.5);
			$pdf->MultiCell(76, 0, $Year,'B', 'C', 0, 0, '', '', true, 0, true);
			$pdf->SetFont($times, '', 15, '', false);
			$pdf->SetXY(114, 179.5);
            ...
            $pdfBig->SetXY(82, 123.3);
			$pdfBig->MultiCell(114, 0, $candidate_name,'B', 'L', 0, 0, '', '', true, 0, true);
			
			$pdfBig->SetFont($times, '', 15, '', false);
			$pdfBig->SetXY(18, 137);
			$pdfBig->MultiCell(45, 0, 'Son / Daughter of',0, 'L', 0, 0, '', '', true, 0, true);
			$pdfBig->SetFont($times, '', 13, '', false);
            $pdfBig->SetXY(58, 137.3);
			$pdfBig->MultiCell(138, 0, $Parents_Name,'B', 'L', 0, 0, '', '', true, 0, true);
			...
			$pdfBig->SetFont($times, '', 15, '', false);
			$pdfBig->SetXY(18, 179.5);
			$pdfBig->MultiCell(0, 0, 'held in',0, 'L', 0, 0, '', '', true, 0, true);
			$pdfBig->SetFont($times, '', 13, '', false);
            $pdfBig->SetXY(35, 179.5);
			$pdfBig->MultiCell(76, 0, $Year,'B', 'C', 0, 0, '', '', true, 0, true);
			$pdfBig->SetFont($times, '', 15, '', false);
			...
			$pdfBig->SetFont($times, '', 13, '', false);
            $pdfBig->SetXY(19, 194);
			$pdfBig->MultiCell(175, 0, $Placed_in,'B', 'C', 0, 0, '', '', true, 0, true);
