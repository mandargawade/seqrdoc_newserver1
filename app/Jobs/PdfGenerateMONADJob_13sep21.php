    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        */
        ...
        for ($i=0; $i < $actual_subj_count ; $i++) { 
            ...
            $pdf->MultiCell(65.4, $cell_height, $subjectsArr[$i][0],$cell_border_sub, 'L', 0, 0);
            $pdf->SetFont($arialb, '', 10, '', false); 
            $pdf->MultiCell(7.2, $cell_height, $subjectsArr[$i][12], $cell_border, 'C', 0, 0);
            $pdf->MultiCell(10, $cell_height, $subjectsArr[$i][1], $cell_border, 'C', 0, 0);
            $pdf->MultiCell(10, $cell_height, $subjectsArr[$i][2], $cell_border, 'C', 0, 0);
            $pdf->MultiCell(10, $cell_height, $subjectsArr[$i][3], $cell_border, 'C', 0, 0);
            $pdf->MultiCell(10, $cell_height, $subjectsArr[$i][4], $cell_border, 'C', 0, 0);
            $pdf->MultiCell(10, $cell_height, $subjectsArr[$i][5], $cell_border, 'C', 0, 0);
            $pdf->MultiCell(10, $cell_height, $subjectsArr[$i][6], $cell_border, 'C', 0, 0);
            $pdf->MultiCell(10, $cell_height, $subjectsArr[$i][7], $cell_border, 'C', 0, 0);
            $pdf->MultiCell(10, $cell_height, $subjectsArr[$i][8], $cell_border, 'C', 0, 0);
            $pdf->MultiCell(10, $cell_height, $subjectsArr[$i][9], $cell_border, 'C', 0, 0);
            ...
            $pdf->MultiCell(8.4, $cell_height, $subjectsArr[$i][11], $cell_border, 'C', 0, 0);  
            ...
            $pdfBig->MultiCell(65.4, $cell_height, $subjectsArr[$i][0],$cell_border_sub, 'L', 0, 0);
            $pdfBig->SetFont($arialb, '', 10, '', false); 
            $pdfBig->MultiCell(7.2, $cell_height, $subjectsArr[$i][12], $cell_border, 'C', 0, 0);
            $pdfBig->MultiCell(10, $cell_height, $subjectsArr[$i][1], $cell_border, 'C', 0, 0);
            $pdfBig->MultiCell(10, $cell_height, $subjectsArr[$i][2], $cell_border, 'C', 0, 0);
            $pdfBig->MultiCell(10, $cell_height, $subjectsArr[$i][3], $cell_border, 'C', 0, 0);
            $pdfBig->MultiCell(10, $cell_height, $subjectsArr[$i][4], $cell_border, 'C', 0, 0);
            $pdfBig->MultiCell(10, $cell_height, $subjectsArr[$i][5], $cell_border, 'C', 0, 0);
            $pdfBig->MultiCell(10, $cell_height, $subjectsArr[$i][6], $cell_border, 'C', 0, 0);
            $pdfBig->MultiCell(10, $cell_height, $subjectsArr[$i][7], $cell_border, 'C', 0, 0);
            $pdfBig->MultiCell(10, $cell_height, $subjectsArr[$i][8], $cell_border, 'C', 0, 0);
            $pdfBig->MultiCell(10, $cell_height, $subjectsArr[$i][9], $cell_border, 'C', 0, 0);
            $pdfBig->MultiCell(10, $cell_height, $subjectsArr[$i][10].'<br><span style="color:yellow;">'.$subjectsArr[$i][10].'</span>', $cell_border, 'C', 0, 0, '', '', true, 0, true);
            $pdfBig->MultiCell(8.4, $cell_height, $subjectsArr[$i][11], $cell_border, 'C', 0, 0);  
