...
class PdfGenerateSdmBscResitJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			$pdfBig->MultiCell(92, 0, "SDM College Medical Sciences and Hospital, Sattur, Dharwad – 580009, Karnataka, India",0, 'C', 0, 0);
            ...
            $pdf->SetXY(51.5, 283);
            $pdf->MultiCell(92, 0, "SDM College Medical Sciences and Hospital, Sattur, Dharwad – 580009, Karnataka, India",0, 'C', 0, 0);
			/******End pdfBig ******/
