...
class PdfGenerateBiharEcourtFeeTestJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        // foreach ($studentDataOrg as $studentData) {
            ...
            // }
                ...
                {
                    $bgPath="C:/Inetpub/vhosts/seqrdoc.com/httpdocs/demo/public/estamp/backend/canvas/bg_pdfs/bd/EStampingBihar_Rs_2_".count($studentDataOrg['data'])."Ups.pdf";//EStampingBihar_Rs_2_28_03_2023_test_4.pdf";//EStampingBihar_CourtFee_Cyan_20P_31_03_2023.pdf";//
                    ...
                    $bgPath="C:/Inetpub/vhosts/seqrdoc.com/httpdocs/demo/public/estamp/backend/canvas/bg_pdfs/ws/WelfareStamp_".count($studentDataOrg['data']).".pdf";//WelfareStamp_28_03_2023_test_2.pdf";//WelfareStamp_1_29_03_2023_1.pdf";//
                    foreach($studentDataOrg['data'] as $studentData) 
                    {
                        if($i%3==1){
                            $stampX = 7.7;
                        ...
                        $pdfBig->SetFont($TimesNewRoman_B, 'B', 6, '', false);
