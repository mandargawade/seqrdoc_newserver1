...
class PdfGenerateUNEBJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
            ...
            $pdfBig->SetFont($universe, '', 12.7, '', false);
            $text = 'This is ro certify that the candidate named below sat <span style="font-size:12.7;font-family:'.$univerNextPro.';"> Uganda Certificate of Education/Uganda Advanced Certificate of Education</span> Examinations and obtained the following results:-';
            $pdfBig->setXY(17, 87);
