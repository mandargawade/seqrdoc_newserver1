                ...
                switch ($printerName) {
                    ...
                    case 'HP405':
                                ...
                                */
                                ...
                                $bgPath="C:/Inetpub/vhosts/seqrdoc.com/httpdocs/demo/public/estamp/backend/canvas/bg_pdfs/EStampingBihar_4P_BG_14_03.pdf";
...
*/
                ...
                $partyName = $this->microLine($partyName, 55, 2.1, $subdomain[0]);
                $pdfBig->SetFont($arial, '', 2.1, '', false);
       ...
       $msg = '';
        ...
        $file_name =  str_replace("/", "_",'BiharEstampCert'.$printerName.date("Ymdhms")).'.pdf';
