...
class ValidateExcelRawatpuraJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        if($dropdown_template_id==1){
            if($columnsCount1==18){
                //$photo_col=23;
				$columnArr=array("Unique_id", "Programme Name", "Programme Name in Hindi", "Branch Name", "Branch Name in Hindi", "Student Name in English", "Student Name in Hindi", "Enrollment No.", "ID No. / Roll Number", "Year of Passing", "Grand Total", "Maximum Marks of The course", "Percentage", "Division", "CGPA", "CGPA in Hindi", "Serial no. of Degree", "REMARK");
