...
class PdfGenerateBiharEstampEcourtJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        $preview_serial_no=1;
        $log_serial_no = 1;
        $cardDetails=$this->getNextCardNo('BiharEstampEcourtCert');
        ...
        // foreach ($studentDataOrg as $studentData) {
            ...
            // if($previewPdf==1){
                // if($previewWithoutBg!=1){
                    //if($studentDataOrg['e-Court Fee Receipt No.']!="M-12345678"){
            ...
            // }
                $fontSize = 11;
                $certificateDateAndTime = $studentDataOrg['Date & Time'];

                if($studentDataOrg['e-Court Fee Amount'] != "")
                    $ecourtFeeAmount = $studentDataOrg['e-Court Fee Amount'];
                else
                    $ecourtFeeAmount = $certificateDateAndTime;

                if($studentDataOrg['e-Court Fee Receipt No.'] != "")
                    $ecourtFeeReceiptNo = $studentDataOrg['e-Court Fee Receipt No.'];
                else
                    $ecourtFeeReceiptNo = $certificateDateAndTime;
                
                if($studentDataOrg['Name of Applicant'] != "")
                    $nameofApplicant = $studentDataOrg['Name of Applicant'];
                else
                    $nameofApplicant = $certificateDateAndTime;

                if($studentDataOrg['Printer'] != "")
                    $printerName = $studentDataOrg['Printer'];
                else
                    $printerName = $certificateDateAndTime;

                if($studentDataOrg['Name of the ACC/ Registered User'] != "")
                    $NameofTheAccUser = $studentDataOrg['Name of the ACC/ Registered User'];
                else
                    $NameofTheAccUser = $certificateDateAndTime;
                

                $location = $studentDataOrg['Location'];
                $paperNumber = $studentDataOrg['Paper Number'];

                $rupees = substr($ecourtFeeAmount, 0, strpos($ecourtFeeAmount, "("));

                $repeatEcourtFeeReceiptNo = $this->microLine($ecourtFeeReceiptNo, 750, 8, $subdomain[0]);
              
                $repeatNameofApplicant = $this->microLine($nameofApplicant, 750, 8, $subdomain[0]);
                 $repeatNameofTheAccUser = $this->microLine($NameofTheAccUser, 750, 8, $subdomain[0]);
              
                    $microFontSize=2.1;
                $repeatIssueDate = $this->microLine($certificateDateAndTime, 99, $microFontSize, $subdomain[0]);
                ...
                $serial_no=$GUID=$ecourtFeeReceiptNo;
                $dt = date("_ymdHis");
                $str=$ecourtFeeReceiptNo.$dt;

                $encryptedString = strtoupper(md5($str));
                 
                $qr_code_path = public_path().'\\'.$subdomain[0].'\backend\canvas\images\qr\/'.$encryptedString.'.png';
    
                //$resultsQR = $ecourtFeeReceiptNo.' | '.$certificateDateAndTime.' | '.$nameofApplicant.' | '.$ecourtFeeAmount;
                $resultsQR = '2 | '.$ecourtFeeReceiptNo.' | '.$certificateDateAndTime.' | '.$NameofTheAccUser.' | '.$location.' | '.$nameofApplicant.' | '.$ecourtFeeReceiptNo.' | '.$ecourtFeeAmount.' | '.$paperNumber;
                ...
                switch ($printerName) {
                    case 'HP305':
                               ...
                               // $bgPath="C:/Inetpub/vhosts/seqrdoc.com/httpdocs/demo/public/estamp/backend/canvas/bg_pdfs/EStampingBihar_305_25p_Cyan_Judicial_20_03_2023.pdf";
                               // $bgPath="C:/Inetpub/vhosts/seqrdoc.com/httpdocs/demo/public/estamp/backend/canvas/bg_pdfs/EStampingBihar_Judicial_25P_28_03_2023.pdf";
                                $bgPath="C:/Inetpub/vhosts/seqrdoc.com/httpdocs/demo/public/estamp/backend/canvas/bg_pdfs/EStampingBihar_305_25P_Judicial_30_03_2023.pdf";
                                break;
                    case 'HP403':

                                $opacityVariableText=3.5;
                                $opacityVariableAmount=5;
                              //  $bgPath="C:/Inetpub/vhosts/seqrdoc.com/httpdocs/demo/public/estamp/backend/canvas/bg_pdfs/EStampingBihar_403_20p_Yellow_Judicial_20_03_2023.pdf";
                               // $bgPath="C:/Inetpub/vhosts/seqrdoc.com/httpdocs/demo/public/estamp/backend/canvas/bg_pdfs/EStampingBihar_Judicial_22P_28_03_2023.pdf";
                                $bgPath="C:/Inetpub/vhosts/seqrdoc.com/httpdocs/demo/public/estamp/backend/canvas/bg_pdfs/EStampingBihar_403_22P_Judicial_30_03_2023.pdf";
                                break;
                    case 'HP405':
                                $opacityVariableText=3.5;
                                $opacityVariableAmount=5;
                            //    $bgPath="C:/Inetpub/vhosts/seqrdoc.com/httpdocs/demo/public/estamp/backend/canvas/bg_pdfs/EStampingBihar_405_8p_Judicial_Cyan_20_03_2023.pdf";
                               // $bgPath="C:/Inetpub/vhosts/seqrdoc.com/httpdocs/demo/public/estamp/backend/canvas/bg_pdfs/EStampingBihar_405_Cyan_22P_21_03_2023.pdf";
                                // $bgPath="C:/Inetpub/vhosts/seqrdoc.com/httpdocs/demo/public/estamp/backend/canvas/bg_pdfs/EStampingBihar_Judicial_25P_28_03_2023.pdf";
                                 $bgPath="C:/Inetpub/vhosts/seqrdoc.com/httpdocs/demo/public/estamp/backend/canvas/bg_pdfs/EStampingBihar_405_25P_Judicial_30_03_2023.pdf";
                                break;
                ...
                $pdfBig->setXY(15, 55);//68
                $pdfBig->MultiCell(180, 0, 'e-Court Fee', '', 'C', 0, 1);
                ...
                $pdfBig->setXY(9, 66);
                $pdfBig->MultiCell($text_width+5, 0, 'e-Court Fee Receipt No.', 0, 'L', 0, 0);
                $pdfBig->MultiCell(4, 0, ':', 0, 'L', 0, 0);
                $pdfBig->MultiCell(105, 0, $ecourtFeeReceiptNo, 0, 'L', 0, 0);
                ...
                {
                    if($key == 'e-Court Fee Receipt No.' || $key == 'Paper Number'){
                        continue;
                    }
               ...
               // $pdfBig->SetTextColor(0, 0, 0, $opacityVariableText);
                ...
                $pdfBig->Cell(201.5, 0, $repeatEcourtFeeReceiptNo, 0, 1, 'L', 0, '', 4);

                $pdfBig->setXY(4.5, 53.3);
                $pdfBig->Cell(201.5, 0, $repeatEcourtFeeReceiptNo, 0, 1, 'L', 0, '', 4); //new

                $pdfBig->setXY(4.5, 63.1);
                $pdfBig->Cell(201.5, 0, $repeatNameofTheAccUser, 0, 1, 'L', 0, '', 4); //new
                ...
                $pdfBig->Cell(201.5, 0, $repeatNameofApplicant, 0, 1, 'L', 0, '', 4);//new
                ...
                $pdfBig->Cell(201.5, 0, $repeatNameofApplicant, 0, 1, 'L', 0, '', 4);
                ...
                $pdfBig->Cell(201.5, 0, $repeatEcourtFeeReceiptNo, 0, 1, 'L', 0, '', 4);
                // $pdfBig->MultiCell(201.5, 0, $repeatEcourtFeeReceiptNo, '', 'L', 0, 1);
                $pdfBig->setXY(4.5, 230.8);
                $pdfBig->Cell(201.5, 0, $repeatNameofApplicant, 0, 1, 'L', 0, '', 4);
                // $pdfBig->MultiCell(201.5, 0, $repeatNameofApplicant, '', 'L', 0, 1);
               ...
               // $pdfBig->setXY(94, 75.5);
                $pdfBig->setXY(89, 62);
                $pdfBig->Cell(32, 0, $repeatIssueDate, 0, 1, 'L', 0, '', 4);
               ...
               /* }else{
                ...
                $nameofApplicant = $this->microLine($nameofApplicant, 55, $microFontSize, $subdomain[0]);
                $pdfBig->SetFont($arial, '', $microFontSize, '', false);
                $pdfBig->setXY(22, 265);//265
                $pdfBig->Cell(19, 0, $nameofApplicant, 0, 1, 'L', 0, '', 4);
                // $pdfBig->MultiCell(19, 0, $nameofApplicant, '', 'L', 0, 1);
                ...
                // $name = substr(str_replace(' ','',strtoupper($ecourtFeeReceiptNo)), 3, 10);
                $name=preg_replace("/[^0-9]/", "",$ecourtFeeReceiptNo);    
            ...
            if($previewPdf!=1){
                ...
                $this->addPrintDetails($username, $print_datetime, $printer_name, $print_count, $print_serial_no, $serial_no,'BiharEstampEcourtCert',$admin_id,$card_serial_no);
       ...
       if($previewPdf!=1){
        $this->updateCardNo('BiharEstampEcourtCert',$card_serial_no-$cardDetails->starting_serial_no,$card_serial_no);
       }
       $msg = '';
        //$file_name_pre =  str_replace("/", "_",'BiharEstampEcourtCert'.date("Ymdhms"));
        //$file_name =  str_replace("/", "_",'BiharEstampEcourtCert'.$printerName.date("Ymdhms")).'.pdf';
       $file_name =  str_replace("/", "_",$ecourtFeeReceiptNo.'_'.$printerName).'.pdf';
       ...
       //$filename = public_path().'/backend/tcpdf/examples/'.$file_name;
        ...
        //if($ecourtFeeReceiptNo=="M-12345678"){
        ...
        if($previewPdf!=1){
          ...
          $pyscript = $directoryUrlBackward."Python_files\\estamp_merge_compress.py";
