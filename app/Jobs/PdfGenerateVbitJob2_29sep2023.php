...
class PdfGenerateVbitJob2
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			$high_res_bg="VBIT_consolidated_BG.jpg"; // VBIT_consolidated_BG, VBIT_consolidated_BG_DATA
			...
			//$photo = $studentData[16];
			$Marksheet = trim($studentData[17]);
            ...
            $pdf->MultiCell(0, 10, $University, 0, 'L', 0, 0);
			$pdf->SetXY($left_str_x+15, $left_title5_y);
            $pdf->MultiCell(75, 10, $Class_Awarded, 0, 'L', 0, 0, '', '', true, 0, true);
			if($degree_numlines_pdf>1){
				$pdf->SetXY($left_str_x+3.5, $left_title6_y-1.5);
			}else{
				$pdf->SetXY($left_str_x+3.5, $left_title6_y);
			}			
            $pdf->MultiCell(112, 7, $Degree, 0, 'L', 0, 0);
			$pdf->SetXY($left_str_x+14, $left_title7_y);
			...
			$pdf->SetXY(131, $left_title5_y - 1.5);
            $pdf->Cell(35, 0, $Memo_No, 0, false, 'L');
            //End pdf 
            ...
            $pdfBig->MultiCell(0, 10, $University, 0, 'L', 0, 0);
			$pdfBig->SetXY($left_str_x+15, $left_title5_y);
            $pdfBig->MultiCell(75, 10, $Class_Awarded, 0, 'L', 0, 0, '', '', true, 0, true);
			if($degree_numlines_pdfBig>1){
				$pdfBig->SetXY($left_str_x+3.5, $left_title6_y-1.5);
			}else{
				$pdfBig->SetXY($left_str_x+3.5, $left_title6_y);
			}			
            $pdfBig->MultiCell(112, 7, $Degree, 0, 'L', 0, 0);
			$pdfBig->SetXY($left_str_x+14, $left_title7_y);
			...
			$pdfBig->SetXY(131, $left_title5_y - 1.5);
            $pdfBig->Cell(35, 0, $Memo_No, 0, false, 'L');
			//$pdfBig->MultiCell(35, 0, $Memo_No, 0, 'L', 0, 0, '', '', true, 0, true);
            //End pdfBig 
