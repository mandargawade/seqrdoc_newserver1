    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
           ...
           //data processing
                ...
                $profile_path_org_jpg = public_path().'\\'.$subdomain[0].'\backend\templates\100\\'.$studentData[5].'.jpg';
                $profile_path_org_png = public_path().'\\'.$subdomain[0].'\backend\templates\100\\'.$studentData[5].'.png';
