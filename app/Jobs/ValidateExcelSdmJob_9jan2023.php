...
class ValidateExcelSdmJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
		...
		elseif($dropdown_template_id==11){
            if($columnsCount1==141){
                $columnArr=array("MC_No.", "Name_of_the_Student", "University_Reg_No.", "Year", "Specialization", "MONTH YEAR - MAIN EXAMINATION", "SL.no1", "SUBJECT CODE 1", "SUBJECT 1", "UE_MAX1", "UE_MIN1", "UE_SEC1", "IA_MAX1", "IA_MIN1", "IA_SEC1", "T_MAX1", "T_MIN1", "T_SEC1", "GRADE GR 1", "GRADE POINT GP 1", "CREDIT CR 1", "CREDIT POINT1", "REMARKS 1", "SL.no2", "SUBJECT CODE 2", "SUBJECT 2", "UE_MAX2", "UE_MIN2", "UE_SEC2", "IA_MAX2", "IA_MIN2", "IA_SEC2", "T_MAX2", "T_MIN2", "T_SEC2", "GRADE GR 2", "GRADE POINT GP 2", "CREDIT CR 2", "CREDIT POINT2", "REMARKS 2", "SL.no3", "SUBJECT CODE 3", "SUBJECT 3", "UE_MAX3", "UE_MIN3", "UE_SEC3", "IA_MAX3", "IA_MIN3", "IA_SEC3", "T_MAX3", "T_MIN3", "T_SEC3", "GRADE GR 3", "GRADE POINT GP 3", "CREDIT CR 3", "CREDIT POINT3", "REMARKS 3", "SL.no4", "SUBJECT CODE 4", "SUBJECT 4", "UE_MAX4", "UE_MIN4", "UE_SEC4", "IA_MAX4", "IA_MIN4", "IA_SEC4", "T_MAX4", "T_MIN4", "T_SEC4", "GRADE GR 4", "GRADE POINT GP 4", "CREDIT CR 4", "CREDIT POINT4", "REMARKS 4", "SL.no5", "SUBJECT CODE 5", "SUBJECT 5", "UE_MAX5", "UE_MIN5", "UE_SEC5", "IA_MAX5", "IA_MIN5", "IA_SEC5", "T_MAX5", "T_MIN5", "T_SEC5", "GRADE GR 5", "GRADE POINT GP 5", "CREDIT CR 5", "CREDIT POINT5", "REMARKS 5", "SL.no6", "SUBJECT CODE 6", "SUBJECT 6", "UE_MAX6", "UE_MIN6", "UE_SEC6", "IA_MAX6", "IA_MIN6", "IA_SEC6", "T_MAX6", "T_MIN6", "T_SEC6", "GRADE GR 6", "GRADE POINT GP 6", "CREDIT CR 6", "CREDIT POINT6", "REMARKS 6", "SL.no7", "SUBJECT CODE 7", "SUBJECT 7", "UE_MAX7", "UE_MIN7", "UE_SEC7", "IA_MAX7", "IA_MIN7", "IA_SEC7", "T_MAX7", "T_MIN7", "T_SEC7", "GRADE GR 7", "GRADE POINT GP 7", "CREDIT CR 7", "CREDIT POINT7", "REMARKS 7", "T_CREDITS CR ", "T_CREDITS POINT", "SEMESTER _CR", "CUMULATIVE_CR", "SGPA", "CGPA", "PERCENTAGE", "CGPA _GRADE", "PERCENTAGE_ GRADE", "RESULT", "Date", "Photo", "Batch_of", "Aadhar_Number", "DOB", "Course");
                $mismatchColArr=array_diff($rowData1[0], $columnArr);
                if(count($mismatchColArr)>0){                    
                    return response()->json(['success'=>false,'type' => 'error', 'message' => 'Sheet1/Json : Column names not matching as per requirement. Please check columns : '.implode(',', $mismatchColArr)]);
                }
