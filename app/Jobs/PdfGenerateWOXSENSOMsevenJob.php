...
EOD;
            ...
            if($term < 4)
            {
                ...
                if($term == 1){
                    $strtd .=   '<tr>  
                                ...
                                <td style="width:19%;text-align:center;border-right:0px solid black;"><B>GPA '.$term.' : '.number_format(round($studentData[$GpaIndex],2),2).'</B></td>
                            </tr>';
                    $IndividualDataIndex++;         
                    $GpaIndex+=2;         
                }else{
                    ...
                    if($term == 3){
						...
						$strtd .=   '<tr style="line-height:0.5px;"><td style="width:10%;text-align:center;border-right:0px solid black;border-left:0px solid black;"></td><td colspan="6" style="border-right:0px solid black;"></td></tr>
									<tr>
						...
						$strtd .=   '<tr>
									...
									<td style="width:7%;text-align:center;"><B></B></td>
									<td style="width:6%;text-align:center;"><B></B></td>
									<td style="width:19%;text-align:center;border-right:0px solid black;"><B>&nbsp;&nbsp;&nbsp;&nbsp;GPA (SIP) : '.number_format(round($T7_GPA,2),2).'</B></td>
								</tr>';    	
							
							//just for bottom style border
							$strtd .=  '<tr style="line-height: 2px;">
											<td style="width:10%;text-align:center;border-right:0px solid black;border-left:0px solid black;border-bottom:0px solid black;height:3px;">&nbsp;</td>
											<td style="width:90%;border-bottom:0px solid black;border-right:0px solid black;height:3px;" colspan="5">&nbsp;</td>
									</tr>';
                ...
                if($term == 4){    
					$strtr .=   '<tr>
                                    ...
                                    <td style="width:7%;text-align:center;"><B></B></td>
                                    <td style="width:6%;text-align:center;"><B></B></td>
                                    <td style="width:19%;text-align:center;"><B>GPA  '.$term.' : '.number_format(round($studentData[$GpaIndex],2),2).'</B></td>
                                </tr>';
					$IndividualDataIndex++;
                    $GpaIndex+=2;			
                }else{
        ...
        */
		$strtr .=   '<tr>
                                    ...
                                    <td style="width:7%;text-align:center;"><B></B></td>
                                    <td style="width:6%;text-align:center;"><B></B></td>
                                    <td style="width:19%;text-align:center;"><B>CGPA: '.number_format(round($CGPA,2),2).'</B></td>
                                </tr>';
        if($Major1!=''){
        $strtr .=   '<tr>
                                    <td style="width:10%;text-align:center;"><B></B></td>
        ...
        $strtr .=   '<tr>
                                    <td style="width:10%;text-align:center;"><B></B></td>
                                    <td style="width:25%;text-align:left;" colspan="2"><B></B></td>
                                    <td style="width:40%;text-align:center;"><B>Total Credit Score: '.$Total_Credits_Earned.'</B></td>
                                    <td style="width:15%;text-align:center;"><B></B></td>
                                    <td style="width:10%;text-align:center;"><B></B></td>
                                </tr>';
