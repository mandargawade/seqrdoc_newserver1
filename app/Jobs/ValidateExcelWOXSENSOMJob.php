...
class ValidateExcelWOXSENSOMJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        $dropdown_template_id=$pdf_data['dropdown_template_id'];
              ...
              $rowData1[0] = array_filter($rowData1[0]);
                ...
                if($columnsCount1==24&&$columnsCount2==6){

                    $columnArr=array('Unique_ID','Student_Name','Father_Name','Program','Academic_Year','PGID','Admission_ID','T1_GPA','T2_GPA','T2_CGPA','T3_GPA','T3_CGPA','T4_GPA','T4_CGPA','T5_GPA','T5_CGPA','T6_GPA','T6_CGPA','T7_GPA','T7_CGPA','T8_GPA','T8_CGPA','Total_Credit','Serial_No');
                ...
                foreach ($rowData1 as $key1 => $value1) {
                    ...
                    $profile_path_jpg = public_path().'\\'.$subdomain[0].'\backend\templates\100\\'.trim($value1[6]).'.jpg';
                    $profile_path_jpeg = public_path().'\\'.$subdomain[0].'\backend\templates\100\\'.trim($value1[6]).'.jpeg';
                    $profile_path_png = public_path().'\\'.$subdomain[0].'\backend\templates\100\\'.trim($value1[6]).'.png';
