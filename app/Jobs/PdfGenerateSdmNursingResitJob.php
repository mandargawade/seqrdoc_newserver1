        ...
        foreach ($studentDataOrg as $studentData) {
			...
			foreach ($subjectsArr as $subjectDatas){
				...
				$pdf->SetFont($MyriadProRegular, '', 10, '', false);					
					...
					$pdfBig->MultiCell(71.5, $th_height, $Subject_Name, 1, 'L', 0, 0);					
					$pdfBig->SetXY(96, $subj_y);
					
					$pdf->SetXY($left_str_x, $subj_y);
					$pdf->MultiCell(9.5, $th_height, $Sr_no, 1, 'C', 0, 0);
					$pdf->MultiCell(71.5, $th_height, $Subject_Name, 1, 'L', 0, 0);					
					$pdf->SetXY(96, $subj_y);
					...
					$pdfBig->MultiCell(18, $th_height_half, $Remark, 1, 'C', 0, 0);
					...
					$pdf->MultiCell(20, $th_height_half, $Remark, 1, 'C', 0, 0);
			...
			$pdfBig->SetXY($left_str_x, $subj_y);	
			$pdfBig->MultiCell(135, 5, 'GRAND TOTAL:', 'LRB', 'R', 0, 0); 
			$pdfBig->SetFont($MyriadProRegular, '', 10, '', false);
