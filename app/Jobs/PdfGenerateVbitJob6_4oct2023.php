...
class PdfGenerateVbitJob6
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			//1st Sem            
            $pdfBig->SetXY(12.4, 89);   
            $pdfBig->MultiCell(8, 16.5, '','LRTB', 'L', 0, 0);
            $pdfBig->MultiCell(119, 16.5, '', 'LRTB', 'C', 0, 0);
            $pdfBig->MultiCell(18, 16.5, '', 'LRTB', 'C', 0, 0);
            $pdfBig->MultiCell(18, 16.5, '', 'LRTB', 'C', 0, 0);
            $pdfBig->MultiCell(19.5, 16.5, '', 'LRTB', 'C', 0, 0);            
            	
            //2nd Sem            
            $pdfBig->SetXY(12.4, 109);   
            $pdfBig->MultiCell(8, 16.5, '','LRTB', 'L', 0, 0);
            $pdfBig->MultiCell(119, 16.5, '', 'LRTB', 'C', 0, 0);
            $pdfBig->MultiCell(18, 16.5, '', 'LRTB', 'C', 0, 0);
            $pdfBig->MultiCell(18, 16.5, '', 'LRTB', 'C', 0, 0);
            ...
            $pdfBig->SetXY(80, 85.6);
			$pdfBig->Cell(0, 0, 'III-I SEMESTER', 0, false, 'L');
			$pdfBig->SetXY(80, 105.6);
			$pdfBig->Cell(0, 0, 'III-II SEMESTER', 0, false, 'L');
			$pdfBig->SetXY(80, 125.6);
			$pdfBig->Cell(0, 0, 'III-III SEMESTER', 0, false, 'L');
			$pdfBig->SetXY(80, 145.6);
			$pdfBig->Cell(0, 0, 'III-IV SEMESTER', 0, false, 'L');
			...
			//1st Sem            
            $pdf->SetXY(12.4, 89);   
            $pdf->MultiCell(8, 16.5, '','LRTB', 'L', 0, 0);
            $pdf->MultiCell(119, 16.5, '', 'LRTB', 'C', 0, 0);
            $pdf->MultiCell(18, 16.5, '', 'LRTB', 'C', 0, 0);
            $pdf->MultiCell(18, 16.5, '', 'LRTB', 'C', 0, 0);
            $pdf->MultiCell(19.5, 16.5, '', 'LRTB', 'C', 0, 0);            
			...
			$pdf->SetXY(80, 125.6);
			$pdf->Cell(0, 0, 'III-III SEMESTER', 0, false, 'L');
			$pdf->SetXY(80, 145.6);
			$pdf->Cell(0, 0, 'III-IV SEMESTER', 0, false, 'L');
            ...
            $pdfBig->SetXY(36, 167);	
			$pdfBig->MultiCell(0, 0, $Credits_Secured.'&nbsp;&nbsp;<span style="color:yellow;font-weight:bold;">'.$Credits_Secured.'</span>', 0, 'L', 0, 0, '', '', true, 0, true);
			...
			$pdfBig->SetXY(13, 176);	
			$pdfBig->writeHTML('<b>Number of Credits Secured in '.$resultFor.' Program :</b> '.$Credits_Secured, true, 0, true, 0);
			...
			$pdfBig->SetXY(12, 245.5);
			$pdfBig->SetFont($arialb, '', 9, '', false);	
			$pdfBig->MultiCell(0, 0, 'DATE :',0, 'L', 0, 0);
			$pdfBig->SetXY(23, 245.5);
			$pdfBig->SetFont($arial, '', 9, '', false);
			$pdfBig->MultiCell(0, 0, $Date,0, 'L', 0, 0);
			...
			$pdf->SetXY(13, 176);	
			$pdf->writeHTML('<b>Number of Credits Secured in '.$resultFor.' Program :</b> '.$Credits_Secured, true, 0, true, 0);
