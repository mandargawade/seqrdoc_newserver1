...
class PdfGenerateRawatpuraCertificate
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
            ...
            $pdfBig->Cell(191, 0, 'us o"kZ '.$passing_year.' esa', 0, false, 'C');
            ...
            $pdfBig->SetTextColor(0, 0, 0);
            $pdfBig->SetXY(10, 134);
            $pdfBig->Cell(191, 0, 'dh ijh{kk '.$cgpa_hindi.'@10 lhthih, ds lkFk lQyrkiwoZd mRrh.kZ dh]', 0, false, 'C');
			$pdfBig->SetFont($K100, '', 20, '', false);        
            $pdfBig->SetTextColor(0, 0, 0);
            $pdfBig->SetXY(10, 144);
            ...
            $pdf->SetTextColor(0, 0, 0);
            $pdf->SetXY(10, 102.5);
            $pdf->Cell(191, 0, 'us o"kZ '.$passing_year.' esa', 0, false, 'C');
            ...
            $pdf->SetTextColor(0, 0, 0);
            $pdf->SetXY(10, 134);
            $pdf->Cell(191, 0, 'dh ijh{kk '.$cgpa_hindi.'@10 lhthih, ds lkFk lQyrkiwoZd mRrh.kZ dh]', 0, false, 'C');
			$pdf->SetFont($K100, '', 20, '', false);        
            $pdf->SetTextColor(0, 0, 0);
            $pdf->SetXY(10, 144);
            ...
            $pdf->SetTextColor(0, 0, 0);
            $pdf->SetXY(10, 170);
            //$pdf->Cell(191, 0, $candidate_name, 0, false, 'C');
            ...
            $pdf->SetTextColor(0, 0, 0);
            $pdf->SetXY(10, 191);
            //$pdf->Cell(191, 0, $programme_name, 0, false, 'C');
