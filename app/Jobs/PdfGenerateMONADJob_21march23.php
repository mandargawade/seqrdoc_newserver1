...
class PdfGenerateMONADJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        */
		...
		$MaxMarks = $studentData[164];
		$totalMarksObt = $studentData[165];
		$Result_SGPA = $studentData[166];
		$session2 = $studentData[167];
		$Photo = $studentData[168];
        ...
        $subjectData = array_slice($studentData, 8, 156);
        ...
        $pdfBig->SetFont($arialb, '', 10, '', false);   
        $pdfBig->SetTextColor(0, 0, 0);
        $pdfBig->SetXY(13.4, 234);
        $pdfBig->Cell(0, 0, 'Marks Obtained', 0, false, 'L');       
        $pdfBig->SetXY(48.7, 234);
        $pdfBig->Cell(0, 0, ':', 0, false, 'L');   
        $pdfBig->SetXY(51.6, 234);
        $pdfBig->Cell(0, 0, $totalMarksObt, 0, false, 'L');  
        $pdfBig->SetTextColor(255, 255, 0);     
        $pdfBig->SetXY(51.6, 238.3);
        $pdfBig->Cell(0, 0, $totalMarksObt, 0, false, 'L');     
        
        $pdfBig->SetFont($arialb, '', 10, '', false);   
        $pdfBig->SetTextColor(0, 0, 0);
        $pdfBig->SetXY(13.4, 244);
        $pdfBig->Cell(0, 0, 'Max. Marks', 0, false, 'L');       
        $pdfBig->SetXY(48.7, 244);
        $pdfBig->Cell(0, 0, ':', 0, false, 'L');   
        $pdfBig->SetXY(51.6, 244);
        $pdfBig->Cell(0, 0, $MaxMarks, 0, false, 'L'); 

        $pdfBig->SetFont($arialb, '', 10, '', false);   
        $pdfBig->SetTextColor(0, 0, 0);
        $pdfBig->SetXY(13.4, 254);
        $pdfBig->Cell(0, 0, 'Date of Issue', 0, false, 'L');
        
        $pdfBig->SetFont($arialb, '', 10, '', false);   
        $pdfBig->SetTextColor(0, 0, 0);
        $pdfBig->SetXY(133, 244);
        $pdfBig->Cell(0, 0, 'Result/SGPA', 0, false, 'L');       
        $pdfBig->SetXY(156, 244);
        $pdfBig->Cell(0, 0, ':', 0, false, 'L');   
        $pdfBig->SetXY(160, 244);
