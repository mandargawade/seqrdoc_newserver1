...
class ValidateExcelVbitJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        if($dropdown_template_id==1){
            if($columnsCount1==26){
                $photo_col=23;
				$columnArr=array("Unique_Id", "Name", "Parents_Name", "Month_&_Year_of_Exam", "University", "Memo_No", "Examination", "Branch", "Gender", "Hall_Ticket_No", "College_Code", "Serial_No", "Subjects_Registered", "Appeared", "Passed", "Total_Grade_Secured", "Total_GI", "Total_Result", "Total_CI", "SGPA", "CGPA", "Place", "Date", "Image", "Marksheet","Note");
		...
		elseif($dropdown_template_id==2){
            if($columnsCount1==22){
                $photo_col=19;
				$columnArr=array("Unique_Id", "Name", "Parents_Name", "Month_&_Year_of_Exam", "University", "Memo_No", "Degree", "Branch", "Gender", "Hall_Ticket_No", "College_Code", "Class_Awarded", "Serial_No", "CGPA Secured", "Honors/Minors", "Credits Registered", "Credits Secured", "Place", "Date", "Image", "Marksheet", "Note");
				$mismatchColArr=array_diff($rowData1[0], $columnArr);
                if(count($mismatchColArr)>0){                    
                    return response()->json(['success'=>false,'type' => 'error', 'message' => 'Sheet1/Json : Column names not matching as per requirement. Please check columns : '.implode(',', $mismatchColArr)]);
                }
		...
		elseif($dropdown_template_id==3){
            if($columnsCount1==20){
				...
				$columnArr=array("Unique_Id", "Name", "Parent's_Name", "Month_&_Year_of_Exam", "Memo_No", "Degree", "Branch", "Gender", "Hall_Ticket_No", "College_Code", "Class Awarded", "Serial_No", "CGPA Secured", "Credits Registered", "Credits Secured", "Place", "Date", "Image", "Marksheet","Note");
                $mismatchColArr=array_diff($rowData1[0], $columnArr);
                if(count($mismatchColArr)>0){                    
                    return response()->json(['success'=>false,'type' => 'error', 'message' => 'Sheet1/Json : Column names not matching as per requirement. Please check columns : '.implode(',', $mismatchColArr)]);
                }
		...
		elseif($dropdown_template_id==5){
            ...
            if($columnsCount1==20){
				...
				//$columnArr=array("Unique_Id", "NAME", "PARENT'S_NAME", "MONTH_&_YEAR_OF_FINAL_EXAM", "MEMO_NO", "DEGREE", "BRANCH", "GENDER", "HALL_TICKET_NO", "COLLAGE_CODE", "SERIAL_ NO", "Honors/Minors", "CGPA_Secured", "Class Awarded", "Credits Registered in Program", "Credits Secured in Program", "Credits Registered in H/M", "Credits Secured in H/M", "Place", "Date", "Image", "Matrksheet");
                $columnArr=array("Unique_Id", "NAME", "PARENT'S_NAME", "MONTH_&_YEAR_OF_FINAL_EXAM", "MEMO_NO", "DEGREE", "BRANCH", "GENDER", "HALL_TICKET_NO", "COLLAGE_CODE", "SERIAL_ NO", "Honors/Minors", "CGPA_Secured", "Class Awarded", "Credits Registered", "Credits Secured", "Place", "Date", "Image", "Matrksheet");
                $mismatchColArr=array_diff($rowData1[0], $columnArr);
                if(count($mismatchColArr)>0){                    
                    return response()->json(['success'=>false,'type' => 'error', 'message' => 'Sheet1/Json : Column names not matching as per requirement. Please check columns : '.implode(',', $mismatchColArr)]);
                }
            ...
            if($columnsCount1==19){
                $photo_col=18;
				$columnArr=array("Unique_Id", "Name", "Parent's_Name", "Month_&_Year_of_Exam", "Memo_No", "Degree", "Branch", "Gender", "Hall_Ticket_No", "College_Code", "Class Awarded", "Serial_No", "CGPA Secured", "Credits Registered", "Credits Secured", "Place", "Date", "Image", "Matrksheet");
                $mismatchColArr=array_diff($rowData1[0], $columnArr);
                if(count($mismatchColArr)>0){                    
                    return response()->json(['success'=>false,'type' => 'error', 'message' => 'Sheet1/Json : Column names not matching as per requirement. Please check columns : '.implode(',', $mismatchColArr)]);
                }
