...
class PdfGenerateMONADJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        $high_res_bg="MONAD_BG.jpg"; //MonadUniversity_With data
        ...
        // \File::copy($profile_path_org,$uv_location);
        }
       //
        ...
        */
        ...
        $pdf->SetXY($right_str_x, $left_title3_y+5);
        ...
        $pdfBig->SetXY($right_str_x, $left_title3_y+5);
        ...
        $strtd="";
        $lineCount=0;
        $total_rows_remain=$count_upto;
        for ($i=0; $i < $count_upto ; $i++) { 
            if(!empty($subjectsArr[$i][0]))
            {
                $lineCount=$lineCount+1;
                $total_rows_remain=$total_rows_remain-1;
                $strtd .= '<tr>
                <td style="width:36.8%;text-align:left;">    
                    <table cellpadding="0" cellspacing="0" style="width:100%;">
                        <tr>
                        <td style="width:2%;"></td>
                        <td style="width:98%;"><b>'.$subjectsArr[$i][0].'</b></td>
                        </tr>
                    </table>    
                </td>
                <td style="width:3.8%;text-align:center;"><b>'.$subjectsArr[$i][12].'</b></td>
                <td style="width:5.4%;text-align:center;"><b>'.$subjectsArr[$i][1].'</b></td>
                <td style="width:5.4%;text-align:center;"><b>'.$subjectsArr[$i][2].'</b></td>
                <td style="width:5.4%;text-align:center;"><b>'.$subjectsArr[$i][3].'</b></td>
                <td style="width:5.4%;text-align:center;"><b>'.$subjectsArr[$i][4].'</b></td>
                <td style="width:5.4%;text-align:center;"><b>'.$subjectsArr[$i][5].'</b></td>
                <td style="width:5.4%;text-align:center;"><b>'.$subjectsArr[$i][6].'</b></td>
                <td style="width:5.4%;text-align:center;"><b>'.$subjectsArr[$i][7].'</b></td>
                <td style="width:5.4%;text-align:center;"><b>'.$subjectsArr[$i][8].'</b></td>
                <td style="width:5.6%;text-align:center;"><b>'.$subjectsArr[$i][9].'</b></td>
                <td style="width:5.6%;text-align:center;"><b>'.$subjectsArr[$i][10].'</b><br><b style="color:yellow;">'.$subjectsArr[$i][10].'</b></td>
                <td style="width:4%;text-align:center;"><b>'.$subjectsArr[$i][11].'</b></td>
               </tr>';
            }
        }
        if($lineCount <= 8){
            if($lineCount <= 6){$sc=$total_rows_remain;}else{if($lineCount == 8){$sc=$total_rows_remain - 2;}else{$sc=$total_rows_remain - 1;}}
            for ($t=0; $t <= $sc ; $t++){                
                $strtd .= '<tr>
                <td style="width:36.8%;text-align:left;"><b></b></td>
                <td style="width:3.8%;text-align:center;"><b></b></td>
                <td style="width:5.4%;text-align:center;"><b></b></td>
                <td style="width:5.4%;text-align:center;"><b></b></td>
                <td style="width:5.4%;text-align:center;"><b></b></td>
                <td style="width:5.4%;text-align:center;"><b></b></td>
                <td style="width:5.4%;text-align:center;"><b></b></td>
                ...
                <td style="width:5.4%;text-align:center;"><b></b></td>
                <td style="width:5.4%;text-align:center;"><b></b></td>
                <td style="width:5.6%;text-align:center;"><b></b></td>
                <td style="width:5.6%;text-align:center;"><b></b></td>
            ...
            if($lineCount == 9){
                /*$strtd .= '<tr>
                <td style="width:36.8%;text-align:left;height:20px;"></td>
                <td style="width:3.8%;text-align:center;height:20px;"></td>
                <td style="width:5.4%;text-align:center;height:20px;"></td>
                <td style="width:5.4%;text-align:center;height:20px;"></td>
                <td style="width:5.4%;text-align:center;height:20px;"></td>
                <td style="width:5.4%;text-align:center;height:20px;"></td>
                <td style="width:5.4%;text-align:center;height:20px;"></td>
                ...
                <td style="width:5.4%;text-align:center;height:20px;"></td>
                <td style="width:5.4%;text-align:center;height:20px;"></td>
                <td style="width:5.6%;text-align:center;height:20px;"></td>
                <td style="width:5.6%;text-align:center;height:20px;"></td>
                <td style="width:4%;text-align:center;height:20px;"></td>
                </tr>'; */
            }
        }
        //$strtdBig=$strtd;
...
<table id="table2" class="t-table borderspace" cellspacing="0" cellpadding="3" border="0.1" width="100%">
  <tr> 
      <th rowspan="3" style="width:36.8%;text-align:center;font-size:0.9em;"></th>
      <th rowspan="3" style="width:3.8%;text-align:center;"></th>
      <th colspan="4" style="width:21.6%;text-align:center;"></th> 
      <th colspan="4" style="width:21.6%;text-align:center;"></th> 
      <th rowspan="2" colspan="2" style="width:11.2%;font-size:0.7em;"></th> 
      <th rowspan="3" style="width:4%;text-align:center;"></th>
  </tr>
  <tr> 
      <th colspan="2" style="width:10.8%;text-align:center;">Theory</th> 
      <th colspan="2" style="width:10.8%;text-align:center;">Practical</th>
      <th colspan="2" style="width:10.8%;text-align:center;">Theory</th> 
      <th colspan="2" style="width:10.8%;text-align:center;">Practical</th>
  </tr>
  <tr>    
    <th style="width:5.4%;text-align:center;">MM</th>
    <th style="width:5.4%;text-align:center;">MO</th>
    <th style="width:5.4%;text-align:center;">MM</th>
    <th style="width:5.4%;text-align:center;">MO</th>
    <th style="width:5.4%;text-align:center;">MM</th>
    <th style="width:5.4%;text-align:center;">MO</th>
    <th style="width:5.4%;text-align:center;">MM</th>
    <th style="width:5.4%;text-align:center;">MO</th>
    <th style="width:5.6%;text-align:center;">MM</th>
    <th style="width:5.6%;text-align:center;">MO</th>
   </tr>
   
    {$strtd}
  </table>
EOD;
        $pdf->writeHTMLCell($w=0, $h=0, $x='12', $y='96', $html, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true);
        $pdfBig->writeHTMLCell($w=0, $h=0, $x='12', $y='96', $html, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true);
        ...
        $pdf->SetFont($arialb, '', 10, '', false);   
        $pdf->SetTextColor(0, 0, 0);
        $pdf->SetXY(13.4, 226.8);
        $pdf->Cell(0, 0, 'Marks Obtained', 0, false, 'L');       
        $pdf->SetXY(48.7, 226.8);
        $pdf->Cell(0, 0, ':', 0, false, 'L');   
        $pdf->SetXY(51.6, 226.8);
        $pdf->Cell(0, 0, $studentData[152], 0, false, 'L');  
        $pdf->SetTextColor(255, 255, 0);     
        $pdf->SetXY(51.6, 231.3);
        $pdf->Cell(0, 0, $studentData[152], 0, false, 'L');     
        ...
        $pdf->Cell(0, 0, ':', 0, false, 'L');   
        $pdf->SetXY(51.6, 236);
        $pdf->Cell(0, 0, $studentData[151], 0, false, 'L'); 
        ...
        $pdf->Cell(0, 0, ':', 0, false, 'L');   
        $pdf->SetXY(160, 226.8);
        $pdf->Cell(0, 0, $studentData[153], 0, false, 'L');
        ...
        $pdfBig->SetFont($arialb, '', 10, '', false);   
        $pdfBig->SetTextColor(0, 0, 0);
        $pdfBig->SetXY(13.4, 226.8);
        $pdfBig->Cell(0, 0, 'Marks Obtained', 0, false, 'L');       
        $pdfBig->SetXY(48.7, 226.8);
        $pdfBig->Cell(0, 0, ':', 0, false, 'L');   
        $pdfBig->SetXY(51.6, 226.8);
        $pdfBig->Cell(0, 0, $studentData[152], 0, false, 'L');  
        $pdfBig->SetTextColor(255, 255, 0);     
        $pdfBig->SetXY(51.6, 231.3);
        $pdfBig->Cell(0, 0, $studentData[152], 0, false, 'L');     
        
        $pdfBig->SetFont($arialb, '', 10, '', false);   
        $pdfBig->SetTextColor(0, 0, 0);
        $pdfBig->SetXY(13.4, 236);
        $pdfBig->Cell(0, 0, 'Max. Marks', 0, false, 'L');       
        $pdfBig->SetXY(48.7, 236);
        $pdfBig->Cell(0, 0, ':', 0, false, 'L');   
        $pdfBig->SetXY(51.6, 236);
        $pdfBig->Cell(0, 0, $studentData[151], 0, false, 'L'); 
        
        $pdfBig->SetFont($arialb, '', 10, '', false);   
        $pdfBig->SetTextColor(0, 0, 0);
        $pdfBig->SetXY(133, 226.8);
        $pdfBig->Cell(0, 0, 'Result/SGPA', 0, false, 'L');       
        $pdfBig->SetXY(156, 226.8);
        $pdfBig->Cell(0, 0, ':', 0, false, 'L');   
        $pdfBig->SetXY(160, 226.8);
        $pdfBig->Cell(0, 0, $studentData[153], 0, false, 'L');
        
        $pdfBig->SetFont($arial, '', 10.2, '', false);   
        $pdfBig->SetTextColor(0, 0, 0);
        $pdfBig->SetXY(13.3, 250.5);
        $pdfBig->Cell(0, 0, 'Date of Issue', 0, false, 'L');
        ...
        $pdfBig->SetAlpha(1);
        $pdfBig->write1DBarcode('1819356', 'C39', $barcodex, $barcodey, $barcodeWidth, $barodeHeight, 0.4, $style1D, 'N');
