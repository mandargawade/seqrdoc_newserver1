...
class ValidateExcelSangamuniJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        if($dropdown_template_id==1){
            if($columnsCount1==11){
                ...
                $columnArr=array("Unique_No", "Enroll_No", "Serial_No", "Student Name", "Father Name", "Degree", "Specialization", "Year", "CGPA", "Date", "Photo");
            ...
            if($columnsCount1==12){
                ...
                $columnArr=array("Unique_No", "Enroll_No", "Serial_No", "Student Name", "Father Name", "Degree", "Specialization", "Year", "PASS", "CGPA", "Date", "Photo");
            ...
            if($columnsCount1==13){
                ...
                $columnArr=array("Unique_No", "Enroll_No", "Serial_No", "Student Name", "Father Name", "Degree", "Course and Branch", "Specialization", "Year", "CGPA", "Title", "Date", "Photo");
            ...
            if($columnsCount1==12){
                ...
                $columnArr=array("Unique_No", "Enroll_No", "Serial_No", "Student Name", "Father Name", "Degree", "Specialization", "Year", "CGPA" , "Division", "Date", "Photo");
            ...
            if($columnsCount1==12){
                ...
                $columnArr=array("Unique_No", "Enroll_No", "Serial_No", "Student Name", "Father Name", "Degree", "Specialization", "Year", "OGPA", "Division", "Date", "Photo");
