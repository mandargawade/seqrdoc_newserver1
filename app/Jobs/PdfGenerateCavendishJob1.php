...
class PdfGenerateCavendishJob1
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) 
        {
            ...
            if(strtoupper($studentData[8]) == 'PASS'){
                $statictext = "Class";
            }else{
                $statictext = "Division";
            }
            ...
            $pdfBig->SetFont($OLD_ENGL, '', 35.5, '', false);
            $pdfBig->SetXY($x, $y);
            $pdfBig->Cell(0, 0, 'Certificate of Merit', 0, false, 'C');
            ...
            $pdf->SetXY($x, $y);
            $pdf->Cell(0, 0, 'It is certified that', 0, false, 'C');

            $pdfBig->SetTextColor(62,64,149);   
            $pdfBig->SetFont($times, '', 16, '', false);
            $pdfBig->SetXY($x, $y);
            $pdfBig->Cell(0, 0, 'It is certified that', 0, false, 'C');
            ...
            $pdfBig->SetTextColor(62,64,149);   
            $pdfBig->SetFont($times, '', 14, '', false);
            $pdfBig->SetXY($x, $y);
            $pdfBig->Cell(0, 0, 'Mr./Ms. ...............................................................................................', 0, false, 'C');
            ...
            $pdfBig->SetFont($times, '', 14, '', false);
            $pdfBig->SetXY($x, $y);
            $pdfBig->Cell(0, 0, 'D/o, S/o ...............................................................................................', 0, false, 'C');
            ...
            $pdf->SetFont($times, '', 16, '', false);
            $pdf->SetXY($x, $y);
            $pdf->Cell(0, 0, 'secured '.$studentData[8].' rank in the', 0, false, 'C');

            $pdfBig->SetTextColor(62,64,149);   
            $pdfBig->SetFont($times, '', 16, '', false);
            $pdfBig->SetXY($x, $y);
            $pdfBig->Cell(0, 0, 'secured '.$studentData[8].' rank in the', 0, false, 'C');


            if(strlen($studentData[7]) > 30)
            {
                $x = 10;
                $y = 146;
                $pdf->SetTextColor(237, 50, 55);   
                $pdf->SetFont($OLD_ENGL, '', 25, '', false);
                $pdf->SetXY($x, $y);
                $pdf->Cell(0, 0, $studentData[6], 0, false, 'C');

                $pdfBig->SetTextColor(237, 50, 55);   
                $pdfBig->SetFont($OLD_ENGL, '', 25, '', false);
                $pdfBig->SetXY($x, $y);
            ...
            $pdf->SetFont($times, '', 16, '', false);
            $pdf->SetXY($x, $y);
            $pdf->Cell(0, 0, 'Degree Examination of the year.......................', 0, false, 'C');

            $pdfBig->SetTextColor(62,64,149);   
            $pdfBig->SetFont($times, '', 16, '', false);
            $pdfBig->SetXY($x, $y);
            $pdfBig->Cell(0, 0, 'Degree Examination of the year.......................', 0, false, 'C');

            if(strtoupper($studentData[8]) == 'SECOND'){
                $x = 10;
                $y = 178.5; //179
                $pdf->SetTextColor(62,64,149);   
                $pdf->SetFont($times, '', 16, '', false);
                $pdf->SetXY($x, $y);
                $pdf->Cell(0, 0, 'He/She is the '.$studentData[8].' topper in the above mentioned degree examination.', 0, false, 'C');

                $pdfBig->SetTextColor(62,64,149);   
                $pdfBig->SetFont($times, '', 16, '', false);
                $pdfBig->SetXY($x, $y);
                $pdfBig->Cell(0, 0, 'He/She is the '.$studentData[8].' topper in the above mentioned degree examination.', 0, false, 'C');
            }else{
                $x = 10;
                $y = 178.5; //179
                $pdf->SetTextColor(62,64,149);   
                $pdf->SetFont($times, '', 16, '', false);
                $pdf->SetXY($x, $y);
                $pdf->Cell(0, 0, 'He/She is the topper in the above mentioned degree examination.', 0, false, 'C');

                $pdfBig->SetTextColor(62,64,149);   
                $pdfBig->SetFont($times, '', 16, '', false);
                $pdfBig->SetXY($x, $y);
                $pdfBig->Cell(0, 0, 'He/She is the topper in the above mentioned degree examination.', 0, false, 'C');
            }
            ...
            $pdfBig->SetFont($times, '', 16, '', false);
            $pdfBig->SetXY($x, $y);
            $pdfBig->Cell(0, 0, 'It is also certified that', 0, false, 'C');
            ...
            $pdf->SetFont($times, '', 16, '', false);
            $pdf->SetXY($x, $y);
            $pdf->Cell(0, 0, 'is the '.$studentData[8].' rank holder among all the students of', 0, false, 'C');

            $pdfBig->SetTextColor(62,64,149);   
            $pdfBig->SetFont($times, '', 16, '', false);
            $pdfBig->SetXY($x, $y);
            $pdfBig->Cell(0, 0, 'is the '.$studentData[8].' rank holder among all the students of', 0, false, 'C');
            ...
            $pdf->SetFont($times, '', 16, '', false);
            $pdf->SetXY($x, $y);
            $pdf->Cell(0, 0, 'affiliated colleges of this University', 0, false, 'C');

            $pdfBig->SetTextColor(62,64,149);   
            $pdfBig->SetFont($times, '', 16, '', false);
            $pdfBig->SetXY($x, $y);
            $pdfBig->Cell(0, 0, 'affiliated colleges of this University', 0, false, 'C');
            ...
            $pdfBig->SetFont($times, '', 16, '', false);
            $pdfBig->SetXY($x, $y);
            $pdfBig->Cell(0, 0, 'who appeared for the same examination and also completed', 0, false, 'C');
            ...
            $pdf->SetFont($times, '', 16, '', false);
            $pdf->SetXY($x, $y);
            $pdf->Cell(0, 0, 'the course within the stipulated time.', 0, false, 'C');

            $pdfBig->SetTextColor(62,64,149);   
            $pdfBig->SetFont($times, '', 16, '', false);
            $pdfBig->SetXY($x, $y);
            $pdfBig->Cell(0, 0, 'the course within the stipulated time.', 0, false, 'C');
            ...
            $pdfBig->SetFont($times, '', 12, '', false);
            $pdfBig->SetXY($x, $y);
            $pdfBig->Cell(0, 0, "Date of Issued : 28/03/2022", 0, false, 'L');
            ...
            $pdfBig->Cell(0, 0, "Registrar", 0, false, 'L');
              ...
              //Signature
            $signature_path = public_path().'\\'.$subdomain[0].'\backend\canvas\images\Registar.png';
            $signaturex = 165;
            $signaturey = 248;
            $signatureWidth = 20;
            $signatureHeight = 20;
            ...
            //$str=$name;
            $str= $studentData[1].", ".$studentData[4].", ".$studentData[6]." ".$studentData[7].", ".$studentData[9].", ".$studentData[8]." Division, ".$studentData[13]."";
            $codeContents = $str;
            ...
            if($previewPdf!=1){
                ...
                $this->addPrintDetails($username, $print_datetime, $printer_name, $print_count, $print_serial_no, $serial_no,'RRMU-M',$admin_id,$card_serial_no);
        ...
        //}
        $msg = '';
        $file_name =  str_replace("/", "_",'RRMU-M'.date("Ymdhms")).'.pdf';
