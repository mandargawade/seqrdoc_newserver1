...
class PdfGenerateBestiuJob7
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
            ...
            $SEM8_COURSE_CODE_7=trim($studentData[340]);
			$SEM8_COURSE_TITLE_7=trim($studentData[341]);
			$SEM8_CREDIT_HOURS_7=trim($studentData[342]);
			$SEM8_GRADE_POINT_7=trim($studentData[343]);
			$SEM8_CREDIT_POINTS_7=trim($studentData[344]);
			$SEM8_COURSE_CODE_8=trim($studentData[345]);
			$SEM8_COURSE_TITLE_8=trim($studentData[346]);
			$SEM8_CREDIT_HOURS_8=trim($studentData[347]);
			$SEM8_GRADE_POINT_8=trim($studentData[348]);
			$SEM8_CREDIT_POINTS_8=trim($studentData[349]);
			...
			for ($x = 1; $x <= 8; $x++) {
				...
				if($x == 1){
					...
					$pdfBig->MultiCell(11, 28, ${"SEM8_COURSE_CODE_" . $x}, 'LB', 'L', 0, 0, '', '', true, 0, true);
					$pdfBig->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
				}
                if($x == 8){
			...
			for ($x = 1; $x <= 8; $x++) {
				...
				if($x == 1){
					...
					$pdf->MultiCell(11, 28, ${"SEM8_COURSE_CODE_" . $x}, 'LB', 'L', 0, 0, '', '', true, 0, true);
					$pdf->setCellPaddings( $left = '', $top = '0', $right = '', $bottom = '');
				}
                if($x == 8){
