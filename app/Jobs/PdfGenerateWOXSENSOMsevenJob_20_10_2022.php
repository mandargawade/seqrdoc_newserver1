...
<table id="table1" cellspacing="0" cellpadding="3" rules="rows" border="0.1" width="47%">
  <tr>
   ...
   <tr>
    ...
    <td width="40%">Academic Year: <b>{$Academic_Year}</b></td>
   </tr>
   <tr>
    <td width="60%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PGID No.: <b>{$PGID}</b></td>
...
EOD;
            ...
            if($term < 4)
            {
                ...
                if($term == 1){
                    $strtd .=   '<tr>
                                ...
                                <td style="width:58%;text-align:left;" colspan="2"><B>Total Credits '.$term.' : '.round($studentData[$IndividualDataIndex],2).'</B></td>
                                <td style="width:7%;text-align:center;"><B></B></td>
                                <td style="width:6%;text-align:center;"><B></B></td>
                                <td style="width:19%;text-align:center;border-right:0px solid black;"><B>GPA - 0'.$term.' : '.round($studentData[$GpaIndex],2).'</B></td>
                            </tr>';
                    $IndividualDataIndex++;         
                    $GpaIndex+=2;         
                }else{
                    $strtd .=   '<tr>
                                    <td style="width:10%;text-align:center;border-right:0px solid black;border-left:0px solid black;"><B></B></td>
                                    <td style="width:58%;text-align:left;" colspan="2"><B>Total Credits '.$term.' : '.round($studentData[$IndividualDataIndex+1],2).'</B></td>
                                    <td style="width:7%;text-align:center;"><B></B></td>
                                    <td style="width:6%;text-align:center;"><B></B></td>
                                    <td style="width:19%;text-align:center;border-right:0px solid black;"><B>GPA - 0'.$term.' : '.round($studentData[$GpaIndex],2).'</B></td>
                                </tr>';
                    ...
                    if($term == 3){
                        ...
                        $strtd .=  '<tr>
                                        <td style="width:10%;text-align:center;border-right:0px solid black;border-left:0px solid black;border-bottom:0px solid black;height:88;"><B></B></td>
                                        <td style="width:90%;border-bottom:0px solid black;border-right:0px solid black;height:88;" colspan="5"></td>
                                </tr>';
                ...
                foreach($term_array as $key => $val)
                {
                    ...
                    $strtr .=       '<td style="width:19%;text-align:center;border-right:0px solid black;"><B></B></td>
                                </tr>';
                }
                    $strtr .= '<tr>
                                    <td style="text-align:center;border-right:0px solid black;border-left:0px solid black;"><B></B></td>
                ...
                if($term == 4){    
					...
					$strtr .=   '<tr>
                                    <td style="width:10%;text-align:center;border-right:0px solid black;border-left:0px solid black;"><B></B></td>
                                    <td style="width:58%;text-align:left;" colspan="2"><B>Total Credits '.$term.' : '.round($studentData[$IndividualDataIndex+2],2).'</B></td>
                                    <td style="width:7%;text-align:center;"><B></B></td>
                                    <td style="width:6%;text-align:center;"><B></B></td>
                                    <td style="width:19%;text-align:center;border-right:0px solid black;"><B>GPA - 0'.$term.' : '.round($studentData[$GpaIndex],2).'</B></td>
                                </tr>';
                ...
                if($term == 6){    
					$strtr .= '<tr>
                            <td style="text-align:center;border-right:0px solid black;border-left:0px solid black;"><B></B></td>
                            <td colspan="6" style="text-align:center;border-right:0px solid black;"><B>Term - 7</B></td>
							</tr>';					
					$strtr .=   '<tr>
					...
					$strtr .=   '<tr>
                                    <td style="width:10%;text-align:center;border-right:0px solid black;border-left:0px solid black;"><B></B></td>
                                    <td style="width:58%;text-align:left;" colspan="2"><B>Total Credits 7 : '.round($TC_7,2).'</B></td>
                                    <td style="width:7%;text-align:center;"><B></B></td>
                                    <td style="width:6%;text-align:center;"><B></B></td>
                                    <td style="width:19%;text-align:center;border-right:0px solid black;"><B>GPA - 07 : '.round($T7_GPA,2).'</B></td>
                                </tr>';                
				}
        ...
        //Total Credits
        $strtr .=   '<tr>
                        <td style="width:10%;text-align:center;border-left: 0px solid black;border-right: 0px solid black;border-bottom: 0px solid black;"><B></B></td>
                        <td style="width:45%;text-align:center;border-bottom: 0px solid black;"><B>Total Credit Score: '.$Total_Credits_Earned.'</B></td>
                        <td style="width:45%;text-align:center;border-bottom: 0px solid black;border-right: 0px solid black;"><B>CGPA: '.$CGPA.'</B></td>
                    </tr>';
