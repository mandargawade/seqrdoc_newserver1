...
class ValidateExcelSpitJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        if($dropdown_template_id==1){
            if($columnsCount1==18){
                $columnArr=array("Unique_Id", "Name", "Examination", "Seat_Number(UID)", "Programme", "Academic_Year", "Semester", "SGPA I", "SGPA II", "SGPA III", "SGPA IV", "SGPA V", "SGPA VI", "SGPA VII", "SGPA VIII", "CGPA", "Remark", "Result_Declared_On");
