    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        // foreach ($studentDataOrg as $studentData) {
            ...
            // }
                ...
                $repeatIssueDate = $this->microLine($certificateIssueDate, 86, 1.2, $subdomain[0]);
                ...
                $pdfBig->setXY(80, 206);
                $pdfBig->MultiCell(85, 0, $htmlVal, '', 'L', 0, 0, '', '', true, 0, true);
                $pdfBig->SetFont($timesNewRoman, '', 12, '', false);
                $pdfBig->setXY(136, 94);
                $pdfBig->MultiCell(25, 0, $html, '', 'L', 0, 1, '', '', true, 0, true);
                ...
                $pdfBig->SetTextColor(0, 0, 0);
                $pdfBig->SetFont($arialB, '', 1.4, '', false);
                $pdfBig->setXY(94, 75.5);
                $pdfBig->Cell(21, 0, $repeatIssueDate, 0, 1, 'L', 0, '', 4);

                $partyName = $this->microLine($partyName, 72, 1.4, $subdomain[0]);
                $pdfBig->SetFont($arialB, '', 1.4, '', false);
                $pdfBig->setXY(22, 265);
        ...
        // $ghostImagex = 116;
        // $ghostImagey = 205.5;
        // $ghostImageWidth = 6.2*strlen($name);//68
        // $ghostImageHeight = 7;
        // // $name = substr(str_replace(' ','',strtoupper($nameOrg)), 0, 12);
