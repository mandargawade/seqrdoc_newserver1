            ...
            // }
                ...
                switch ($printerName) {
                    case 'HP305':
                                ...
                                $bgPath="C:/Inetpub/vhosts/seqrdoc.com/httpdocs/demo/public/estamp/backend/canvas/bg_pdfs/EStampingBihar_Rs_2_25_03_23.pdf";
                                break;
                    case 'HP403':
                ...
                if(strtolower($studentDataOrg['stamp_type']) == "bd")
                {
                    foreach($studentDataOrg['data'] as $studentData) 
                    {
                        ...
                        $pdfBig->write1DBarcode($codeContents, 'C39', $qrCodex, $qrCodey, $qrCodeWidth, $qrCodeHeight,0.4, $style1D, 'N');
                    ...
                    foreach($studentDataOrg['data'] as $studentData) 
                    {
                        ...
                        $pdfBig->setXY($stampX+5, $stampY+3);
                        $pdfBig->MultiCell(50, 18, '', 1, '', 0, 1);

                        $pdfBig->SetFont('mangal', '', 6, '', false);

                        $pdfBig->setXY($stampX + 5, $stampY+16);
                        $pdfBig->MultiCell(30, 0, $studentData['amount_hi'], '', 'C', 0, 1, '', '', true, 0, true);

                        $pdfBig->SetFont($timesNewRoman, '', 6, '', false);
                        $pdfBig->setXY($stampX + 28, $stampY+16);
                        $pdfBig->MultiCell(30, 0, $studentData['amount_en'], '', 'C', 0, 1, '', '', true, 0, true);
                        ...
                        $pdfBig->setXY($stampX, $stampY + 34);
                        $pdfBig->MultiCell(60, 0, $certificateno['code'], '', 'C', 0, 1, '', '', true, 0, true);
