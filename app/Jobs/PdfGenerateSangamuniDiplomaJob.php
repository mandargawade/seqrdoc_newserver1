...
class PdfGenerateSangamuniDiplomaJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
            ...
            $year = \PhpOffice\PhpSpreadsheet\Shared\Date::excelToDateTimeObject($studentData[6])->format('F, Y');;
            $cgpa = $studentData[7];
            $date = \PhpOffice\PhpSpreadsheet\Shared\Date::excelToDateTimeObject($studentData[8])->format('jS F, Y');
            $photo = $studentData[9];
   ...
   //          $pdfBig->MultiCell(27, 0, trim($print_serial_no), 0, 'C', 0, 0);
            ...
            $pdfBig->SetFont('Clearface', '', 18, '', false); 
            $pdfBig->setXY(10,178);
            $pdfBig->MultiCell(186, 4, "the certificate of", '', 'C', 0, 1);
            ...
            $pdfBig->SetFont('Clearface', '', 18, '', false); 
            $pdfBig->setXY(10, 205);
            $pdfBig->MultiCell(186, 4, "in testimony of his/her having successfully completed the\nprescribed programme in ". $year." with CGPA ".$cgpa."\nand awarded on ".$date."\nunder the seal of the Sangam University, Bhilwara", '', 'C', 0, 1);
   ...
   //          $pdf->MultiCell(27, 0, trim($print_serial_no), 0, 'C', 0, 0);
            ...
            $pdf->SetFont('Clearface', '', 18, '', false); 
            $pdf->setXY(10,178);
            $pdf->MultiCell(186, 4, "the certificate of", '', 'C', 0, 1);
            ...
            $pdf->SetFont('Clearface', '', 18, '', false); 
            $pdf->setXY(10, 205);
            $pdf->MultiCell(186, 4, "in testimony of his/her having successfully completed the\nprescribed programme in ". $year." with CGPA ".$cgpa."\nand awarded on ".$date."\nunder the seal of the Sangam University, Bhilwara", '', 'C', 0, 1);
