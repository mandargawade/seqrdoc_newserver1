...
class PdfGenerateVbitJob3
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			$high_res_bg="VBIT_consolidated_BG.jpg"; // VBIT_consolidated_BG, CMM memo grade ug
			$low_res_bg="VBIT_consolidated_BG.jpg";
			$pdfBig->AddPage();
			...
			$pdf->SetXY(12, 85.2);	
			$pdf->MultiCell(92.8, 0, 'I SEMESTER', 0, 'C', 0, 0);
			$pdf->SetXY(12, 85.2);	
			$pdf->MultiCell(185.6, 0, 'I YEAR', 0, 'C', 0, 0);
			$pdf->SetXY(105.5, 85.2);	
			$pdf->MultiCell(92.8, 0, 'II SEMESTER', 0, 'C', 0, 0);
			
			$pdf->SetXY(12, 127.4);	
			$pdf->MultiCell(92.8, 0, 'III SEMESTER', 0, 'C', 0, 0);
			$pdf->SetXY(12, 127.4);	
			$pdf->MultiCell(185.6, 0, 'II YEAR', 0, 'C', 0, 0);
			$pdf->SetXY(105.5, 127.4);	
			$pdf->MultiCell(92.8, 0, 'IV SEMESTER', 0, 'C', 0, 0);
			
			$pdf->SetXY(12, 169.2);	
			$pdf->MultiCell(92.8, 0, 'V SEMESTER', 0, 'C', 0, 0);
			$pdf->SetXY(12, 169.2);	
			$pdf->MultiCell(185.6, 0, 'III YEAR', 0, 'C', 0, 0);
			$pdf->SetXY(105.5, 169.2);	
			$pdf->MultiCell(92.8, 0, 'VI SEMESTER', 0, 'C', 0, 0);
			
			$pdf->SetXY(12, 211.3);	
			$pdf->MultiCell(92.8, 0, 'VII SEMESTER', 0, 'C', 0, 0);
			$pdf->SetXY(12, 211.3);	
			$pdf->MultiCell(185.6, 0, 'IV YEAR', 0, 'C', 0, 0);
			$pdf->SetXY(105.5, 211.3);	
			$pdf->MultiCell(92.8, 0, 'VIII SEMESTER', 0, 'C', 0, 0);	
			...
			for ($lx = 1; $lx <= 4; $lx++) {
				$pdf->SetXY(12, $startY);   
				$pdf->MultiCell(4, 38.5, '', 'LRTB', 'C', 0, 0);
				$pdf->MultiCell(60, 38.5, '', 'LRTB', 'L', 0, 0);
				$pdf->MultiCell(10, 38.5, '', 'LRTB', 'C', 0, 0);
				$pdf->MultiCell(8.5, 38.5, '', 'LRTB', 'C', 0, 0);
				$pdf->MultiCell(10.3, 38.5, '', 'LRTB', 'C', 0, 0); 
				$startY+=42;	
            }			
			//2nd Sem            
            $startSY=88.8;
			...
			$pdfBig->MultiCell(92.8, 0, 'I SEMESTER', 0, 'C', 0, 0);
			$pdfBig->SetXY(12, 85.2);	
			$pdfBig->MultiCell(185.6, 0, 'I YEAR', 0, 'C', 0, 0);
			$pdfBig->SetXY(105.5, 85.2);	
			$pdfBig->MultiCell(92.8, 0, 'II SEMESTER', 0, 'C', 0, 0);
			
			$pdfBig->SetXY(12, 127.4);	
			$pdfBig->MultiCell(92.8, 0, 'III SEMESTER', 0, 'C', 0, 0);
			$pdfBig->SetXY(12, 127.4);	
			$pdfBig->MultiCell(185.6, 0, 'II YEAR', 0, 'C', 0, 0);
			$pdfBig->SetXY(105.5, 127.4);	
			$pdfBig->MultiCell(92.8, 0, 'IV SEMESTER', 0, 'C', 0, 0);
			
			$pdfBig->SetXY(12, 169.2);	
			$pdfBig->MultiCell(92.8, 0, 'V SEMESTER', 0, 'C', 0, 0);
			$pdfBig->SetXY(12, 169.2);	
			$pdfBig->MultiCell(185.6, 0, 'III YEAR', 0, 'C', 0, 0);
			$pdfBig->SetXY(105.5, 169.2);	
			$pdfBig->MultiCell(92.8, 0, 'VI SEMESTER', 0, 'C', 0, 0);
			
			$pdfBig->SetXY(12, 211.3);	
			$pdfBig->MultiCell(92.8, 0, 'VII SEMESTER', 0, 'C', 0, 0);
			$pdfBig->SetXY(12, 211.3);	
			$pdfBig->MultiCell(185.6, 0, 'IV YEAR', 0, 'C', 0, 0);
			$pdfBig->SetXY(105.5, 211.3);	
			$pdfBig->MultiCell(92.8, 0, 'VIII SEMESTER', 0, 'C', 0, 0);
			...
			for ($lx = 1; $lx <= 4; $lx++) {
				...
				$pdfBig->MultiCell(4, 38.5, '', 'LRTB', 'C', 0, 0);
				$pdfBig->MultiCell(60, 38.5, '', 'LRTB', 'L', 0, 0);
				$pdfBig->MultiCell(10, 38.5, '', 'LRTB', 'C', 0, 0);
				$pdfBig->MultiCell(8.5, 38.5, '', 'LRTB', 'C', 0, 0);
				$pdfBig->MultiCell(10.3, 38.5, '', 'LRTB', 'C', 0, 0); 
				$startY+=42;	
            }			
			//2nd Sem            
            $startSY=88.8;
			...
			if($degree_numlines_pdfBig>1){
				$pdf->SetXY($title1_x, $left_title4_y+1);
			}else{
            ...
            $pdf->SetFont($arial, '', $str_font_size, '', false); 
			$pdf->SetXY($left_str_x+14, $left_title2_y);
            $pdf->Cell(75, 0, $hall_ticket_no, 0, false, 'L');
            $pdf->SetXY($left_str_x+26.5, $left_title3_y);
			if($degree_numlines_pdfBig>1){
				$pdf->SetXY($left_str_x+4, $left_title3_y-1.5);
			}else{
				$pdf->SetXY($left_str_x+4, $left_title3_y);
			}	
            $pdf->MultiCell(90, 0, $Degree, 0, 'L', 0, 0);
            if($degree_numlines_pdfBig>1){
				$pdf->SetXY($left_str_x+4, $left_title4_y+1);
			}else{
				$pdf->SetXY($left_str_x+4, $left_title4_y+0.5);
			}			
            $pdf->MultiCell(0, 10, $Branch, 0, 'L', 0, 0);
			$pdf->SetXY($left_str_x+13, $left_title5_y+0.5);
            $pdf->MultiCell(75, 10, $College_Code, 0, 'L', 0, 0, '', '', true, 0, true);					
            $pdf->SetXY($left_str_x+8, $left_title6_y+0.5);
			$pdf->MultiCell(112, 7, $University, 0, 'L', 0, 0);
			$pdf->SetXY($left_str_x+16, $left_title7_y);
            $pdf->MultiCell(155, 10, $Class_Awarded, 0, 'L', 0, 0);
            
            $pdf->SetXY(142.5, $left_title1_y);
            $pdf->Cell(0, 0, $Year_of_Admission, 0, false, 'L');
            $pdf->SetXY(155.5, $left_title2_y);
            //$pdf->Cell(0, 0, $Month_Year_of_Exam, 0, false, 'L');   
			$pdf->MultiCell(18, 0, $Month_Year_of_Exam, 0, 'L', 0, 0);	
			$pdf->SetXY(130, $left_title3_y);
            $pdf->Cell(0, 0, $Memo_No, 0, false, 'L');	
			...
			if($degree_numlines_pdfBig>1){
				$pdfBig->SetXY($title1_x, $left_title4_y+1);
			}else{
            ...
            $pdfBig->SetFont($arial, '', $str_font_size, '', false); 
			$pdfBig->SetXY($left_str_x+14, $left_title2_y);
            $pdfBig->Cell(75, 0, $hall_ticket_no, 0, false, 'L');
            $pdfBig->SetXY($left_str_x+26.5, $left_title3_y);
			if($degree_numlines_pdfBig>1){
				$pdfBig->SetXY($left_str_x+4, $left_title3_y-1.5);
			}else{
				$pdfBig->SetXY($left_str_x+4, $left_title3_y);
			}	
            $pdfBig->MultiCell(90, 0, $Degree, 0, 'L', 0, 0);
            if($degree_numlines_pdfBig>1){
				$pdfBig->SetXY($left_str_x+4, $left_title4_y+1);
			}else{
				$pdfBig->SetXY($left_str_x+4, $left_title4_y+0.5);
			}			
            $pdfBig->MultiCell(0, 10, $Branch, 0, 'L', 0, 0);
			$pdfBig->SetXY($left_str_x+13, $left_title5_y+0.5);
            $pdfBig->MultiCell(75, 10, $College_Code, 0, 'L', 0, 0, '', '', true, 0, true);					
            $pdfBig->SetXY($left_str_x+8, $left_title6_y+0.5);
			$pdfBig->MultiCell(112, 7, $University, 0, 'L', 0, 0);
			$pdfBig->SetXY($left_str_x+16, $left_title7_y);
            $pdfBig->MultiCell(155, 10, $Class_Awarded, 0, 'L', 0, 0);
            
            $pdfBig->SetXY(142.5, $left_title1_y);
            $pdfBig->Cell(0, 0, $Year_of_Admission, 0, false, 'L');
            $pdfBig->SetXY(155.5, $left_title2_y);
            //$pdfBig->Cell(10, 0, $Month_Year_of_Exam, 0, false, 'L'); 
			$pdfBig->MultiCell(18, 0, $Month_Year_of_Exam, 0, 'L', 0, 0);			
			$pdfBig->SetXY(130, $left_title3_y);
            $pdfBig->Cell(0, 0, $Memo_No, 0, false, 'L');	
			...
			$pdf->SetXY(12, 261.5);
			$pdf->SetFont($arialb, '', 9, '', false);	
			$pdf->MultiCell(0, 0, 'Date of Issue :',0, 'L', 0, 0);
			$pdf->SetXY(34, 261.5);
			$pdf->SetFont($arial, '', 9, '', false);
			$pdf->MultiCell(0, 0, $Date,0, 'L', 0, 0);
			$pdf->SetXY(12, 265);
			$pdf->MultiCell(0, 0, 'Mandatory Course<br />Passed for award of degree', 0, 'L', 0, 0, '', '', true, 0, true);
			...
			$pdfBig->SetXY(22.5, 258);	
			$pdfBig->SetFont($arial, '', 9, '', false);
			$pdfBig->MultiCell(0, 0, $Place,0, 'L', 0, 0);
			$pdfBig->SetXY(12, 261.5);
			$pdfBig->SetFont($arialb, '', 9, '', false);	
			$pdfBig->MultiCell(0, 0, 'Date of Issue :',0, 'L', 0, 0);
			$pdfBig->SetXY(34, 261.5);
			$pdfBig->SetFont($arial, '', 9, '', false);
			$pdfBig->MultiCell(0, 0, $Date,0, 'L', 0, 0);
			$pdfBig->SetXY(12, 265);
			$pdfBig->MultiCell(0, 0, 'Mandatory Course<br />Passed for award of degree', 0, 'L', 0, 0, '', '', true, 0, true);
