...
class ValidateExcelSecuraJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        if($dropdown_template_id==1){
            if($columnsCount1==8){
                $columnArr=array("Freedom Fighter No", "Name of the freedom fighther", "Father/Husband Name of FF", "Village/Ward Name", "Post Office","Upazila/Thana Name", "District", "Photo");
