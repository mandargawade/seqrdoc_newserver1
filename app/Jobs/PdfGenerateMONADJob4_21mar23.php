    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        */
        ...
        for ($i=0; $i < $actual_subj_count ; $i++) { 
            ...
            $pdf->MultiCell(10, $cell_height, trim($subjectsArr[$i][10]).'<br><span style="color:yellow;">'.trim($subjectsArr[$i][10]).'</span>', $cell_border, 'C', 0, 0, '', '', true, 0, true);
        ...
        $pdfBig->SetFont($arialb, '', 10, '', false);
        $pdfBig->SetXY(13, 254);          
        $pdfBig->MultiCell(30, 4, "Date of Issue", 0, 'L', 0, 0);
