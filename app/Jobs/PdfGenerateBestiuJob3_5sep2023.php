...
class PdfGenerateBestiuJob3
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
            ...
            $SEM8_COURSE_CODE_3=trim($studentData[379]);
			$SEM8_COURSE_TITLE_3=trim($studentData[380]);
			$SEM8_CREDIT_HOURS_3=trim($studentData[381]);
			$SEM8_GRADE_POINT_3=trim($studentData[382]);
			$SEM8_CREDIT_POINTS_3=trim($studentData[383]);
