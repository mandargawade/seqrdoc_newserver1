        ...
        // foreach ($studentDataOrg as $studentData) {
            ...
            // }
               ...
               // $codeContents = "Purchased By: ".$name."\nCertificate No.: ".$certificateNo."\n\n".$encryptedString;
                ...
                // repeat Rotate microline code
                $microlineEnrollment= $results['Certificate Issued Date'];
                ...
                $variableDateAndTime = substr($variableDateAndTime, 0, 1210);


                // repeat Rotate microline code
                $microlineEnrollment= "FP ".$results['First Party']." SP ".$results['Second Party'];
                $microlineEnrollment = preg_replace('/\s+/', '', $microlineEnrollment);
                $textArrayEnrollment = imagettfbbox(1.3, 0, public_path().'/'.$subdomain[0].'/backend/canvas/fonts/ArialB.TTF', $microlineEnrollment);
                $strWidthEnrollment = ($textArrayEnrollment[2] - $textArrayEnrollment[0]);
                $strHeightEnrollment = $textArrayEnrollment[6] - $textArrayEnrollment[1] / 1.3;
                ...
                $variablePartyName = substr($variablePartyName, 0, 1210);




                // repeat microline code
                $microlineContent= "FP ".$results['First Party']." SP ".$results['Second Party'];
                ...
                $arrayValue = substr($arrayValue, 0, 99);
                ...
                $pdfBig->setXY(90, 66);
                $pdfBig->MultiCell(105, 0, $results['Certificate No.'], '', 'L', 0, 1);
                ...
                $pdf->setXY(90, 66);
                $pdf->MultiCell(105, 0, $results['Certificate No.'], '', 'L', 0, 1);
