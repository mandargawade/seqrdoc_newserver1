...
class PdfGenerateUNEBECOEJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        for($dataIndex=0;$dataIndex<count($studentDataOrg);$dataIndex++){
            ...
            $pdfBig->SetTextColor(0, 0, 0, $opacity);
            $pdfBig->setXY(135, 25);
            $pdfBig->MultiCell(145, 0, 'P.O.BOX 2B PAKWACH', '', 'L', 0, 1);
           ...
           /* $ghostImgArr = array();
            ...
            $pdf->SetTextColor(0, 0, 0, $opacity);
            $pdf->setXY(135, 27);
            $pdf->MultiCell(145, 0, 'P.O.BOX 2B PAKWACH', '', 'L', 0, 1);
            ...
            $pdf->Image("$tmpDir/" . $name."".$ghost_font_size.".png", $ghostImagex, $ghostImagey+2, $w, $ghostImageHeight, "PNG", '', 'C', true, 3600);
            ...
            $ghost_font_size = '11';//13
            $ghostImagex = 88;
            $ghostImagey = 85+$leaf2Offset;
            $ghostImageyVerification = 85;
            //$ghostImageWidth = 55;//68
            ...
            $pdfBig->SetFont($CourierNew, '', 11.1, '', false);
            $pdfBig->SetTextColor(0, 0, 0);
            $pdfBig->setXY(33, 21+$leaf2Offset);
            $pdfBig->MultiCell(100, 0, strtoupper($candidateName), '', 'L', 0, 1);

            $pdfBig->SetFont($CourierNew, '', 11.1, '', false);
            $pdfBig->SetTextColor(0, 0, 0, $opacity);
            $pdfBig->setXY(135, 21+$leaf2Offset);
            $pdfBig->MultiCell(145, 0, strtoupper($indexNo), '', 'L', 0, 1);

            $pdfBig->SetFont($CourierNew, '', 11.1, '', false);
            $pdfBig->SetTextColor(0, 0, 0);
            $pdfBig->setXY(33, 25+$leaf2Offset);
            $pdfBig->MultiCell(100, 0, strtoupper($centreName), '', 'L', 0, 1);

            $pdfBig->SetFont($CourierNew, '', 11.1, '', false);
            $pdfBig->SetTextColor(0, 0, 0, $opacity);
            $pdfBig->setXY(135, 25+$leaf2Offset);
            $pdfBig->MultiCell(145, 0, 'P.O.BOX 2B PAKWACH', '', 'L', 0, 1);


            $pdfBig->SetFont($CourierNew, '', 11.1, '', false);
            $pdfBig->SetTextColor(0, 0, 0);
            $pdfBig->setXY(33, 29+$leaf2Offset);
            $pdfBig->MultiCell(100, 0, 'ENTRY CODE:'.$entryCode, '', 'L', 0, 1);

            $pdfBig->SetFont($CourierNew, '', 11.1, '', false);
            $pdfBig->SetTextColor(0, 0, 0, $opacity);
            $pdfBig->setXY(80, 29+$leaf2Offset);
            $pdfBig->MultiCell(145, 0, 'DATE OF BIRTH:'.$date, '', 'L', 0, 1);
            ...
            $pdfBig->SetFont($CourierNew, '', 11.1, '', false);
            $pdfBig->SetTextColor(0, 0, 0);
            $pdfBig->setXY(25, 80+$leaf2Offset);
            $pdfBig->MultiCell(100, 0, 'GRADE AGGREGATE   '.$aggregate, '', 'L', 0, 1);

            $pdfBig->SetFont($CourierNew, '', 11.1, '', false);
            $pdfBig->SetTextColor(0, 0, 0, $opacity);
            $pdfBig->setXY(100, 80+$leaf2Offset);
            $pdfBig->MultiCell(145, 0, '***  RESULT  '.$resultFinal.'  ***', '', 'L', 0, 1);
            ...
            $pdf->Image("$tmpDir/" . $name."".$ghost_font_size.".png", $ghostImagex, $ghostImageyVerification+2, $w, $ghostImageHeight, "PNG", '', 'C', true, 3600);
            ...
            $pdfBig->SetFont($CourierNew, '', 11.1, '', false);
            $pdfBig->SetTextColor(0, 0, 0);
            $pdfBig->setXY(33, 21+$leaf3Offset);
            $pdfBig->MultiCell(100, 0, strtoupper($candidateName), '', 'L', 0, 1);

            $pdfBig->SetFont($CourierNew, '', 11.1, '', false);
            $pdfBig->SetTextColor(0, 0, 0, $opacity);
            $pdfBig->setXY(135, 21+$leaf3Offset);
            $pdfBig->MultiCell(145, 0, strtoupper($indexNo), '', 'L', 0, 1);

            $pdfBig->SetFont($CourierNew, '', 11.1, '', false);
            $pdfBig->SetTextColor(0, 0, 0);
            $pdfBig->setXY(33, 25+$leaf3Offset);
            $pdfBig->MultiCell(100, 0, strtoupper($centreName), '', 'L', 0, 1);

            $pdfBig->SetFont($CourierNew, '', 11.1, '', false);
            $pdfBig->SetTextColor(0, 0, 0, $opacity);
            $pdfBig->setXY(135, 25+$leaf3Offset);
            $pdfBig->MultiCell(145, 0, 'P.O.BOX 2B PAKWACH', '', 'L', 0, 1);


            $pdfBig->SetFont($CourierNew, '', 11.1, '', false);
            $pdfBig->SetTextColor(0, 0, 0);
            $pdfBig->setXY(33, 29+$leaf3Offset);
            $pdfBig->MultiCell(100, 0, 'ENTRY CODE:'.$entryCode, '', 'L', 0, 1);

            $pdfBig->SetFont($CourierNew, '', 11.1, '', false);
            $pdfBig->SetTextColor(0, 0, 0, $opacity);
            $pdfBig->setXY(80, 29+$leaf3Offset);
            $pdfBig->MultiCell(145, 0, 'DATE OF BIRTH:'.$date, '', 'L', 0, 1);
            ...
            $pdfBig->SetFont($CourierNew, '', 11.1, '', false);
            $pdfBig->SetTextColor(0, 0, 0, $opacity);
            $pdfBig->setXY(100, 80+$leaf3Offset);
            $pdfBig->MultiCell(145, 0, '***  RESULT  '.$resultFinal.'  ***', '', 'L', 0, 1);
