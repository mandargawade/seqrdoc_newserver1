...
class PdfGenerateVbitJob6
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
			...
			$pdfBig->SetFont($arialNarrow, '', 7, '', false);
			$pdfBig->MultiCell(29, 11, $Class_Awarded.'&nbsp;&nbsp;<span style="color:yellow;font-weight:bold;">'.$Class_Awarded.'</span>', 0, 'L', 0, 0, '', '', true, 0, true);
			...
			$pdf->MultiCell(0, 0, $Credits_Secured.'&nbsp;&nbsp;<span style="color:yellow;font-weight:bold;">'.$Credits_Secured.'</span>', 0, 'L', 0, 0, '', '', true, 0, true);
			...
			$pdf->SetFont($arialNarrow, '', 7, '', false);
			$pdf->MultiCell(29, 11, $Class_Awarded.'&nbsp;&nbsp;<span style="color:yellow;font-weight:bold;">'.$Class_Awarded.'</span>', 0, 'L', 0, 0, '', '', true, 0, true);
