...
class ValidateExcelKmtcJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        if($dropdown_template_id==1){
            if($columnsCount1==12){
                $columnArr=array("Unique Serial No.","Name","College No.","Programme","Faculty","Department","Completion","Duration","Admission","Graduation","Serial No.","Issue Date");
