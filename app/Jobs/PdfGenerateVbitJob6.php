...
class PdfGenerateVbitJob6
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) {
            ...
            $pdfBig->MultiCell(8, 23.5, '','LRTB', 'L', 0, 0);
            $pdfBig->MultiCell(119, 23.5, '', 'LRTB', 'C', 0, 0);
            $pdfBig->MultiCell(18, 23.5, '', 'LRTB', 'C', 0, 0);
            $pdfBig->MultiCell(18, 23.5, '', 'LRTB', 'C', 0, 0);
            $pdfBig->MultiCell(19.5, 23.5, '', 'LRTB', 'C', 0, 0);            
            	
            //2nd Sem            
            $pdfBig->SetXY(12.4, 116);   
            $pdfBig->MultiCell(8, 23.5, '','LRTB', 'L', 0, 0);
            $pdfBig->MultiCell(119, 23.5, '', 'LRTB', 'C', 0, 0);
            $pdfBig->MultiCell(18, 23.5, '', 'LRTB', 'C', 0, 0);
            $pdfBig->MultiCell(18, 23.5, '', 'LRTB', 'C', 0, 0);
