...
class PdfGenerateSpitJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        $examination = $studentData[2];
        $seat_number = $studentData[3];
        $programme_name = $studentData[4];        
        $academic_year = $studentData[5];
        $semester = $studentData[6];
        $SGPA_I = $studentData[7];
        $SGPA_II = $studentData[8];
        $SGPA_III = $studentData[9];
        $SGPA_IV = $studentData[10];
        $SGPA_V = $studentData[11];
        $SGPA_VI = $studentData[12];
        $SGPA_VII = $studentData[13];
        $SGPA_VIII = $studentData[14];
        $CGPA = $studentData[15];
        $remark = $studentData[16];
        $result_declared_on = $studentData[17];
        ...
        $pdfBig->Cell(0, 0, $semester, 0, false, 'L');     
        //End pdfBig 
        /* get courses by specific seat number */
        $reg_nos = array_keys(array_combine(array_keys($second_sheet), array_column($second_sheet, '0')),$seat_number);
        ...
        foreach ($reg_nos as $key => $value){
            $Course_Code=$second_sheet[$value][1]; 
            $Course_Name=$second_sheet[$value][2];
            $Course_Credits=$second_sheet[$value][3];
            $Grade=$second_sheet[$value][4];
            $Credits_Earned=$second_sheet[$value][5];
            $Grade_Points=$second_sheet[$value][6];
            $C_GP=$second_sheet[$value][7];
        ...
        $pdfBig->SetXY(16.7, 208.5);     
        $pdfBig->MultiCell(95, 2, '',0, 'L', 0, 0);        
        $pdfBig->MultiCell(14.5, 10, '00<br><span style="color:yellow;">00</span>', 0, 'C', 0, 0, '', '', true, 0, true);
        $pdfBig->MultiCell(16.5, 10, '00<br><span style="color:yellow;">00</span>', 0, 'C', 0, 0, '', '', true, 0, true);
        $pdfBig->MultiCell(19.5, 10, '00<br><span style="color:yellow;">00</span>', 0, 'C', 0, 0, '', '', true, 0, true);
        $pdfBig->MultiCell(19, 10, '00<br><span style="color:yellow;">00</span>', 0, 'C', 0, 0, '', '', true, 0, true);
        $pdfBig->MultiCell(12, 10, '00<br><span style="color:yellow;">00</span>', 0, 'C', 0, 0, '', '', true, 0, true);
        //Table 2
       ...
       if($previewPdf!=1){
        //$this->updateCardNo('spit',$card_serial_no-$cardDetails->starting_serial_no,$card_serial_no);
       }
       $msg = '';
