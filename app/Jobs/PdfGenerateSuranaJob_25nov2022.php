...
class PdfGenerateSuranaJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
		...
		$SR_Credits_Earned_key=$pdf_data[''];
        ...
        foreach ($studentDataOrg as $studentData) {
            ...
            $pdfBig->SetXY(15, 75.5);     
            $pdfBig->MultiCell(5, 110, '','LRTB', 'L', 0, 0); //SL
            $pdfBig->MultiCell(62, 110, '','LRTB', 'L', 0, 0); //COURSE/CODE
            $pdfBig->MultiCell(74, 110, '', 'LRTB', 'C', 0, 0); //Marks
            $pdfBig->MultiCell(7, 110, '', 'LRTB', 'C', 0, 0); //GRADE POINTS
            $pdfBig->MultiCell(6, 110, '', 'LRTB', 'C', 0, 0); //CREDITS ASSIGNED
            $pdfBig->MultiCell(7, 110, '', 'LRTB', 'C', 0, 0); //CREDIT POINTS
            $pdfBig->MultiCell(19, 110, '', 'LRTB', 'C', 0, 0); //REMARKS
			...
			$pdfBig->SetXY(82, 81);
			$pdfBig->MultiCell(26.5, 100, '','TR', 'L', 0, 0); //TPP See
			$pdfBig->MultiCell(20.5, 100, '','TR', 'L', 0, 0); //IA
			$pdfBig->MultiCell(27, 100, '','TR', 'L', 0, 0); //Course Total
			
			$pdfBig->SetXY(82, 93);
			$pdfBig->MultiCell(8, 92.5, '','TR', 'L', 0, 0); //TPP Max
			$pdfBig->MultiCell(6, 92.5, '','TR', 'L', 0, 0); //Min
			$pdfBig->MultiCell(12.5, 88, '','T', 'L', 0, 0); //Secured			
			$pdfBig->MultiCell(7.5, 88, 'MAX',0, 'L', 0, 0, 82.5, 94.5, true, 0, true); //Max
			$pdfBig->MultiCell(6.3, 88, 'MIN',0, 'L', 0, 0, 90, 94.5, true, 0, true); //Min
			$pdfBig->MultiCell(14, 88, 'SECURED',0, 'L', 0, 0, 95.5, 94.5, true, 0, true); //Secured			
			
			$pdfBig->SetXY(108.5, 93);
			$pdfBig->MultiCell(8, 92.5, '','LTR', 'L', 0, 0); //IA Max
			$pdfBig->MultiCell(12.5, 92.5, '','TR', 'L', 0, 0); //Secured
			$pdfBig->MultiCell(7.5, 88, 'MAX',0, 'L', 0, 0, 109, 94.5, true, 0, true); //Max
			$pdfBig->MultiCell(14, 88, 'SECURED',0, 'L', 0, 0, 116.2, 94.5, true, 0, true); //Secured
			
			$pdfBig->SetXY(129, 93);
			$pdfBig->MultiCell(8, 92.5, '','TR', 'L', 0, 0); //Course Total Max
			$pdfBig->MultiCell(6, 92.5, '','TR', 'L', 0, 0); //Min
			$pdfBig->MultiCell(13, 92.5, '','TR', 'L', 0, 0); //Secured
			$pdfBig->MultiCell(7.5, 88, 'MAX',0, 'L', 0, 0, 129.5, 94.5, true, 0, true); //Max
			$pdfBig->MultiCell(6.3, 88, 'MIN',0, 'L', 0, 0, 137, 94.5, true, 0, true); //Min
			$pdfBig->MultiCell(14, 88, 'SECURED',0, 'L', 0, 0, 143, 94.5, true, 0, true); //Secured
			//end pdfBig
            //start pdf
            $pdf->SetXY(15, 75.5);
            ...
            $pdf->SetXY(15, 75.5);     
            $pdf->MultiCell(5, 110, '','LRTB', 'L', 0, 0); //SL
            $pdf->MultiCell(62, 110, '','LRTB', 'L', 0, 0); //COURSE/CODE
            $pdf->MultiCell(74, 110, '', 'LRTB', 'C', 0, 0); //Marks
            $pdf->MultiCell(7, 110, '', 'LRTB', 'C', 0, 0); //GRADE POINTS
            $pdf->MultiCell(6, 110, '', 'LRTB', 'C', 0, 0); //CREDITS ASSIGNED
            $pdf->MultiCell(7, 110, '', 'LRTB', 'C', 0, 0); //CREDIT POINTS
            $pdf->MultiCell(19, 110, '', 'LRTB', 'C', 0, 0); //REMARKS
			...
			$pdf->SetXY(82, 81);
			$pdf->MultiCell(26.5, 100, '','TR', 'L', 0, 0); //TPP See
			$pdf->MultiCell(20.5, 100, '','TR', 'L', 0, 0); //IA
			$pdf->MultiCell(27, 100, '','TR', 'L', 0, 0); //Course Total
			
			$pdf->SetXY(82, 93);
			$pdf->MultiCell(8, 92.5, '','TR', 'L', 0, 0); //TPP Max
			$pdf->MultiCell(6, 92.5, '','TR', 'L', 0, 0); //Min
			$pdf->MultiCell(12.5, 88, '','T', 'L', 0, 0); //Secured			
			$pdf->MultiCell(7.5, 88, 'MAX',0, 'L', 0, 0, 82.5, 94.5, true, 0, true); //Max
			$pdf->MultiCell(6.3, 88, 'MIN',0, 'L', 0, 0, 90, 94.5, true, 0, true); //Min
			$pdf->MultiCell(14, 88, 'SECURED',0, 'L', 0, 0, 95.5, 94.5, true, 0, true); //Secured			
			
			$pdf->SetXY(108.5, 93);
			$pdf->MultiCell(8, 92.5, '','LTR', 'L', 0, 0); //IA Max
			$pdf->MultiCell(12.5, 92.5, '','TR', 'L', 0, 0); //Secured
			$pdf->MultiCell(7.5, 88, 'MAX',0, 'L', 0, 0, 109, 94.5, true, 0, true); //Max
			$pdf->MultiCell(14, 88, 'SECURED',0, 'L', 0, 0, 116.2, 94.5, true, 0, true); //Secured
			
			$pdf->SetXY(129, 93);
			$pdf->MultiCell(8, 92.5, '','TR', 'L', 0, 0); //Course Total Max
			$pdf->MultiCell(6, 92.5, '','TR', 'L', 0, 0); //Min
			$pdf->MultiCell(13, 92.5, '','TR', 'L', 0, 0); //Secured
			$pdf->MultiCell(7.5, 88, 'MAX',0, 'L', 0, 0, 129.5, 94.5, true, 0, true); //Max
			$pdf->MultiCell(6.3, 88, 'MIN',0, 'L', 0, 0, 137, 94.5, true, 0, true); //Min
			$pdf->MultiCell(14, 88, 'SECURED',0, 'L', 0, 0, 143, 94.5, true, 0, true); //Secured
			//end pdf			
