...
class PdfGenerateAUROJob
{
    ...
    public function handle(CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal)
    {
        ...
        foreach ($studentDataOrg as $studentData) 
        {
            ...
            $pdf->AddPage();
            //set background image
            $template_img_generate = public_path().'\\'.$subdomain[0].'\backend\canvas\bg_images\AURO_Shroff_grade_BG_Low_Res.jpg';
            if($previewPdf!=1){
            ...
            if($previewPdf!=1){
                //Invisbile Serial Number
                    ...
                    $pdfBig->SetFont($verdana, 'B', 8.5, '', false);
                    $pdfBig->SetXY($x, $y);
                    ...
                    $pdfBig->SetFont($verdana, '', 8.5, '', false);
                    $pdfBig->SetXY($x, $y);
                    $pdfBig->Cell(0, 0, $invisible_namestr, 0, false, 'L');
                    ...
                    $pdfBig->Image($invisible_logo, $x, $y, '55', '29', "PNG", '', 'R', true);
            ...
            $pdfBig->SetFont($danishRegular, '', 27, '', false);
            $pdfBig->SetXY($x, $y);
            $pdfBig->Cell(0, 0, 'having satisfied all the '.strtolower($studentData[7]).' requiremnets', 0, false, 'C');
            ...
            if(!empty($studentData[5])){
                ...
                $pdfBig->SetFont($danishRegular, '', 27, '', false);
                $pdfBig->SetXY($x, $y);
                $pdfBig->Cell(0, 0, 'Signed and sealed at Surat, Gujarat, this twelth day of January in the year two thousand and twenty two', 0, false, 'C');
