                    ...
                    if (!$userData) 
                    {
                        ...
                        if ($id)
                        {
                            ...
                            try{
                                ...
                                return response()->json(['status' => true,'message' => 'Registration done successfully.', 'verification_method' => $verify_by, 'mobile_no' => $student_mob_no, 'code' => 200]);
                ...
                if (!empty($employer_name) && !empty($employer_reg_no) && !empty($employer_working_sector) && (!empty($employer_address) || $subdomain[0]=="demo" || $subdomain[0]=="monad") && !empty($employer_mob_no) && !empty($employer_email)) {
                    ...
                    if (!$userData) {
                        ...
                        try{
                            ...
                            return response()->json(['status' => true,'message' => 'Registration done successfully.','verification_method' => $verify_by, 'mobile_no' => $employer_mob_no,'code' => 200]);
