...
{        
    ...
    public function importFfData(Request $request){
        ...
        if($api_option==2){  
            ...
            if (is_array($object2['records']) || is_object($object2['records'])){
                ...
                return response()->json(['success'=>true, 'message'=>$total_record.' records imported successfully.', 'fresh_records'=>$fresh_records, 'repeat_records'=>$repeat_records, 'records'=>'Found']);
            }else{
    ...
    public function REimportFfData(Request $request){
        ...
        if($api_option==2){  
            ...
            Session::save();            
            $apiKey="";        
            $params = "per_page=$per_page&page_no=$page_no&district=$district&upazilla=$upazilla&ff_category=$ff_category";            
            $total_record=$per_page;
            $total_pages=1; 
            $cnt=1;
            $fresh=1;
