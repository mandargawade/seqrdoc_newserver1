...
$strtd .= '<tr>
    ...
    <td style="width:6%;text-align:center;"><b>8.5</b></td>
   </tr>';
$strtd .= '<tr>
...
for ($i=4; $i <17 ; $i++) { 
 ...
 $strtd .= '<tr>
    ...
    <th style="width:6%;text-align:center;"><b>8.5</b></th>
   </tr>';
     $html = <<<EOD
<style>
 th{
...
<table id="table4" cellspacing="0" cellpadding="2" border="0.1" width="99%">
    ...
    <th style="width:16%;text-align:left;">Grade : A</th>
    <th style="width:16%;text-align:left;">Credit Earned : 20</th>
    <th style="width:16%;text-align:left;">SGPA : 8.55</th>
    <th style="width:16%;text-align:left;">CGPA : </th>
    <th style="width:16%;text-align:left;">Overall : A</th>
    </tr>
    <tr>
    ...
    <td style="width:14%;text-align:left;">Sem V : <b>1.00</b></td>
    <td style="width:14%;text-align:left;">Sem VI: <b>1.00</b></td>
    </tr>
    <tr>
...
<table id="table5" cellspacing="0" cellpadding="2" border="0.1" width="99%">
    ...
    <tr>
    <td style="width:9%;text-align:center;"><b>1</b></td>
    <td colspan="2" style="width:54%;text-align:left;">ADVANCE EXCEL</td>
    <td style="width:12%;text-align:center;">2</td>
    <td style="width:12%;text-align:center;">Sem I</td>
    <td style="width:13%;text-align:center;">A</td>
    </tr>
   <tr>
    <td style="width:9%;text-align:center;"><b>2</b></td>
    <td colspan="2" style="width:54%;text-align:left;">ADVANCE EXCEL</td>
    <td style="width:12%;text-align:center;">2</td>
    <td style="width:12%;text-align:center;">Sem II</td>
    ...
    <td style="width:12%;text-align:center;">Sem III</td>
    <td style="width:13%;text-align:center;"></td>
    </tr>
    <tr>
    <td style="width:9%;text-align:center;"></td>
    <td colspan="2" style="width:54%;text-align:left;"></td>
    <td style="width:12%;text-align:center;"></td>
    <td style="width:12%;text-align:center;">Sem IV</td>
    <td style="width:13%;text-align:center;"></td>
    </tr>
    <tr>
    <td style="width:9%;text-align:center;"></td>
    <td colspan="2" style="width:54%;text-align:left;"></td>
    <td style="width:12%;text-align:center;"></td>
    <td style="width:12%;text-align:center;">Sem V</td>
    <td style="width:13%;text-align:center;"></td>
    </tr>
    <tr>
    ...
    <th style="width:12%;text-align:center;">4</th>
    <td style="width:12%;text-align:center;">Sem VI</td>
    <td style="width:13%;text-align:center;"></td>
    </tr>
  </table>
EOD;
