    ...
    public function uploadpage(){
     ...
     public function uploadfile(Request $request,CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal){
       ...
       /* echo json_encode(array("studentData"=>$rowData1,"subjects"=>$rowData2));
        exit;*/
        $pdfData=array('studentDataOrg'=>$rowData1,'subjectsDataOrg'=>$rowData2,'auth_site_id'=>$auth_site_id,'template_id'=>$template_id,'previewPdf'=>$previewPdf,'excelfile'=>$excelfile);
...
// Ghost image
    ...
    public function pdfSample(){
       ...
       // $pdf->SetTextColor(189, 189, 189,7,false,'');
        ...
        $ghostImageWidth = 44;
        $ghostImageHeight = 8;
        $name = str_replace(' ','',substr('ARORA ANUBHAV SANDEEP', 0, 6));
        ...
        $pdf->Image("$tmpDir/" . $name."".$ghost_font_size.".png", $ghostImagex, $ghostImagey, $ghostImageWidth, $ghostImageHeight, "PNG", '', 'L', true, 3600,false,false,false,true,true);
        $ghostImagex = 23.5;
        $ghostImagey = 275.5;
        //$pdf->Image("$tmpDir/" . $name."".$ghost_font_size.".png", $ghostImagex, $ghostImagey, $ghostImageWidth, $ghostImageHeight, "PNG", '', 'L', true, 3600);
        //delete temp dir 26-04-2022 
