...
class UASBCertificateController extends Controller
{
    ...
    public function databaseGenerate(){
       ...
       //Query FOR UGPG 
        $fetch_degree_data_prog_spec = DB::select( DB::raw('SELECT DISTINCT degree_eng, COUNT(sr_no) as sr_no_count FROM ug_pg WHERE ugpg_eng="Post Graduate" AND STATUS="0" GROUP BY degree_eng ORDER BY sr_no_count ASC limit 3,1') );
      ...
      $serial_no_split = (string)($serial_no);
       ...
       foreach ($strArr as $character) {
        ...
        if(strlen($str)>145){
            ...
            $strNew=$str." "."CzsÀåAiÀÄ£À ªÀÄAqÀ½ ºÁUÀÆ «zÁå«µÀAiÀÄPÀ ¥ÀjµÀwÛ£À ²¥sÁgÀ¹ì£À ªÉÄÃgÉUÉ";
            ...
            if(strlen($strNew)<=290){
                ...
                $str="¥ÀjµÀwÛ£À ²¥sÁgÀ¹ì£À ªÉÄÃgÉUÉ";
        ...
        if(trim($fetch_degree_data[$excel_row]['degree_eng'])=="Master of Technology (Agricultural Engineering)"){
