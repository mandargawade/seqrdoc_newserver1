...
class TestCertificateController extends Controller
{
    ...
    public function kewiTest(Request $request)
    {
            echo "test";
           ;
            return true;
...
*/        //$fontEBPath=public_path().'\\'.$subdomain[0].'\backend\canvas\fonts\E-13B_0.php';
      ...
      /*  $x= 10;
        ...
        $pdf->SetFont('freesans',0, $font_size, '', false);
        
        $pdf->Cell($x, $y, $str, 0, $ln=0,  'L', 0, '', 0, false, 'B', 'B');*/
     ...
     public function insertData(Request $request){
        ...
        $pyscript = $directoryUrlBackward."Python_files\\session.py";
        ...
        exit;
        $template_id=13;
        $template_name="KMTC Transcript 2021";
        ...
        return response()->json(['success'=>true,'type' => 'success', 'message' => 'success']);
    ...
    public function addCertificate($serial_no,$key, $certName, $dt,$template_id,$admin_id)
    {
    ...
    //get print count from printing details
    ...
    //next serial number for printingdetails
