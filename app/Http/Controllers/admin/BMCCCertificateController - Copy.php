...
class BMCCCertificateController extends Controller
{
    ...
    public function uploadpage(){
     ...
     public function uploadfile(Request $request,CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal){
        ...
        unset($rowData1[0]);
        unset($rowData2[0]);
        array_values($rowData1);
        array_values($rowData2);
        //store ghost image
        ...
        foreach ($rowData1 as $readData) {
           ...
           $matching = array_intersect_key($rowData2, array_intersect($readData[3]));
           print_r($matching);
    ...
    public function certificateGenerate($studentData,$subjects){
...
<table id="table1" cellspacing="0" cellpadding="2" border="0.1" width="46.4%" rules="rows">
  <tr>
   ...
   <tr>
    <td colspan="2">  Examination Programme : <b>{$studentData[6]}</b></td>
    <td>  Year : <b>{$studentData[7]}</b></td>
   </tr>
   <tr>
    <td>  Permanent Reg . No : <b>{$studentData[3]}</b></td>
    <td style="text-align:center">  Seat Number : <b>{$studentData[0]}</b></td>
    <td> UID. No : <b>{$studentData[4]}</b></td>
   </tr>
  </table>
EOD;
...
EOD;
$pdf->writeHTMLCell($w=0, $h=0, $x='12', $y='63.3', $html, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true);
...
for ($i=0; $i <24 ; $i++) { 
  ...
  $strtd .= '<tr>
    ...
    <td style="width:39%;text-align:left;"><b>SERVICES OPERATIONS MANAGEMENT AND
QUALITY ISSUES (SPL)</b></td>
...
<table id="table2" class="t-table borderspace" cellspacing="0" cellpadding="2" border="0.1" width="46.4%">
  <tr>
   ...
   <tr>
    <td style="width:11%;text-align:center;"><b>SEM I</b></td>
    <td style="width:39%;text-align:left;"></td>
    <td style="width:5%;text-align:center;"></td>
    <td style="width:5%;text-align:center;"></td>
    <td style="width:7%;text-align:center;"></td>
...
QUALITY ISSUES (SPL)</b></td>
   ...
   <tr>
    <td style="width:11%;text-align:center;"><b>SEM V</b></td>
    <td style="width:39%;text-align:left;"></td>
    <td style="width:5%;text-align:center;"></td>
    <td style="width:5%;text-align:center;"></td>
    <td style="width:7%;text-align:center;"></td>
...
<table id="table1" cellspacing="0" cellpadding="2" border="0.1" width="46.4%" rules="rows">
  <tr>
    <td colspan="2">  Student Name :  <b>Bhavendra Manoj Kumar </b></td>
    <td>  Mother's Name :  <b>Bhavika </b></td>
   </tr>
   <tr>
    <td colspan="2">  Examination Programme : <b>BACHELOR OF COMMERCE</b></td>
    <td>  Year : <b>2020</b></td>
   </tr>
   <tr>
    <td>  Permanent Reg . No : <b>1700020001</b></td>
    <td style="text-align:center">  Seat Number : <b>00001</b></td>
    <td> UID. No : <b>202012345</b></td>
   </tr>
  </table>
EOD;
$pdf->writeHTMLCell($w=0, $h=0, $x='12', $y='46', $html, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true);
