...
use Helper;
use App\Jobs\ValidateExcelICCSJob;
use App\Jobs\PdfGenerateICCSJob;
class ICCSCertificateController extends Controller
{
    public function index(Request $request)
    {
       return view('admin.iccs.index');
    }
...
<table id="table1" cellspacing="0" cellpadding="2" border="0.1" width="88%" rules="rows">
   <tr>
    <td colspan="2"> STATEMENT FOR GRADES FOR :  <b>BSC_CS_2020 Patteren</b></td>
    <td> SEMESTER : <b>I</b></td>
   </tr>
   <tr>
   <td> SEAT NO.: <b>BSCSC02000 263</b></td>
   <td> PUN CODE : <b>ICCS-Pune</b></td>
   <td> EXAM : <b>20 April 2021</b></td>
   </tr>
   <tr>
    <td colspan="3"> NAME : <b>Shrivastav Purshottam Ramkisan</b></td>
   </tr>
    <tr>
    <td colspan="3"> MOTHER : <b>Bagawade Rameshwari</b></td>
   </tr>
   <tr>
    <td style="width:45%;"> PERN REG N0. : <b>20ICCSBSC0189</b></td>
    <td colspan="2"  style="width:55%;"> ELIGIBILITY NO . : <b>12020107811</b></td>
   </tr>
  </table>
EOD;
...
$strtd .= '<tr>
    <td style="width:72%;">  CS-111-Problemems Solving using computers and C Programming</td>
    <td style="width:7%;text-align:center;">2</td>
    <td style="width:7%;text-align:center;">F</td>
    <td style="width:7%;text-align:center;">0</td>
    <td style="width:7%;text-align:center;">0</td>
   </tr>';
$strtd .= '<tr>
    <td style="width:72%;">  ELC-111-Semiconductor Devices And Basic Electronic Systems</td>
    <td style="width:7%;text-align:center;">2</td>
    <td style="width:7%;text-align:center;">A</td>
    <td style="width:7%;text-align:center;">8</td>
    <td style="width:7%;text-align:center;">16</td>
   </tr>';
$strtd .= '<tr>
    <td style="width:72%;">  CSST-122-Continuous Probability Distribution and Testing of Hypothesis</td>
    <td style="width:7%;text-align:center;">2</td>
    <td style="width:7%;text-align:center;">A+</td>
...
$strtd .= '<tr>
    <td style="width:72%;">  CS-123-Practical course based on CS121 and CS122</td>
    <td style="width:7%;text-align:center;">2</td>
    <td style="width:7%;text-align:center;">O</td>
    <td style="width:7%;text-align:center;">10</td>
    <td style="width:7%;text-align:center;">20</td>
   </tr>';

$strtd .= '<tr>
    <td style="width:72%;">  CS-122-Relational Database Management Systems</td>
    <td style="width:7%;text-align:center;">2</td>
    <td style="width:7%;text-align:center;">B+</td>
    <td style="width:7%;text-align:center;">7</td>
    <td style="width:7%;text-align:center;">14</td>
   </tr>';

$strtd .= '<tr>
    <td style="width:72%;">  CSST-121-Methods of Applied  Statistics</td>
    <td style="width:7%;text-align:center;">2</td>
...
$strtd .= '<tr>
    <td style="width:72%;">  ELC - 122-Basics of Computer Organization</td>
    <td style="width:7%;text-align:center;">2</td>
    <td style="width:7%;text-align:center;">B+</td>
    <td style="width:7%;text-align:center;">6</td>
    <td style="width:7%;text-align:center;">12</td>
...
$strtd .= '<tr>
    <td style="width:72%;">  CSST- 123-Statistics Practicals II</td>
    <td style="width:7%;text-align:center;">2</td>
    <td style="width:7%;text-align:center;">A+</td>
    <td style="width:7%;text-align:center;">9</td>
    <td style="width:7%;text-align:center;">18</td>
...
$strtd .= '<tr>
    <td style="width:72%;">  ELC-121-Instumentation Systems</td>
    <td style="width:7%;text-align:center;">2</td>
    <td style="width:7%;text-align:center;">C</td>
...
$strtd .= '<tr>
    <td style="width:72%;">  MTC-122-Graph Theory</td>
    <td style="width:7%;text-align:center;">2</td>
    <td style="width:7%;text-align:center;">A</td>
    <td style="width:7%;text-align:center;">8</td>
    <td style="width:7%;text-align:center;">16</td>
...
$strtd .= '<tr>
    <td style="width:72%;">  ELC - 112-Principles of Digital Electronics</td>
    <td style="width:7%;text-align:center;">2</td>
    <td style="width:7%;text-align:center;">F</td>
    <td style="width:7%;text-align:center;">0</td>
    <td style="width:7%;text-align:center;">0</td>
...
$strtd .= '<tr>
    <td style="width:72%;">  ELC - 113-Electronics Practical Lab IA</td>
    <td style="width:7%;text-align:center;">1.5</td>
    <td style="width:7%;text-align:center;">A+</td>
    <td style="width:7%;text-align:center;">9</td>
    <td style="width:7%;text-align:center;">13.5</td>
   </tr>';


$strtd .= '<tr>
    <td style="width:72%;">  CSST-I-Discriptive Statistics - I</td>
    <td style="width:7%;text-align:center;">2</td>
    <td style="width:7%;text-align:center;">A</td>
    <td style="width:7%;text-align:center;">6</td>
    <td style="width:7%;text-align:center;">12</td>
...
$strtd .= '<tr>
    <td style="width:72%;">  CSST-113-Statistics Practical I</td>
    <td style="width:7%;text-align:center;">1.5</td>
    <td style="width:7%;text-align:center;">O</td>
    <td style="width:7%;text-align:center;">10</td>
...
for ($i=4; $i <19 ; $i++) { 
   ...
   $strtd .= '<tr>
    <td style="width:72%;">  12019-VA02_2-EMPLYBILITY SKILL ENHANCEMENT PROGRAM</td>
...
$strtd .= '<tr>
    <td style="width:72%;line-height:2;">  <b>First Semester SGPA: Credits Earned / Total 3/19 Total Credits Points : 140</b></td>
    <td style="width:7%;text-align:center;"></td>
    <td style="width:7%;text-align:center;"></td>
    <td style="width:7%;text-align:center;"></td>
    <td style="width:7%;text-align:center;"></td>
...
*/
  ...
  $strtd .= '<tr>
    <td style="width:72%;line-height:2;">  <b>Second Semester SGPA: Credits Earned / Total 17/23 Total Credits Points : 144</b></td>
    <td style="width:7%;text-align:center;"></td>
    <td style="width:7%;text-align:center;"></td>
    <td style="width:7%;text-align:center;"></td>
    <td style="width:7%;text-align:center;"></td>
...
$pdf->writeHTMLCell($w=0, $h=0, $x='10.5', $y='235', $html, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true);
      ...
      $pdf->SetXY(12, 258);
      $pdf->Cell(0, 0, "Result : Second", 0, $ln=0,  'L', 0, '', 0, false, 'B', 'B');
      
      $pdf->SetFont($arialb,0, 9, '', false);
      $pdf->SetXY(12, 262);
      $pdf->Cell(0, 0, "Result Date : 20 April 2021", 0, $ln=0,  'L', 0, '', 0, false, 'B', 'B');
    
      $pdf->SetFont($arial,0, 9, '', false);
      $pdf->SetXY(12, 263);
      $pdf->Cell(0, 0, "Medium of Instruction : English", 0, $ln=0,  'L', 0, '', 0, false, '', '');
    ...
    $style1Da = array(
            ...
            'stretchtext' => 3
                ...
                $pdf->write1DBarcode(trim("PN/18-19/356"), 'C39', $barcodex, $barcodey, $barcodeWidth, $barodeHeight, 0.4, $style1Da, 'N');
        // Ghost image
        $nameOrg="Shrivastav Purshottam Ramkisan";
        $ghost_font_size = '13';
        $ghostImagex = 142;
        $ghostImagey = 273.5;
     ...
     public function validateExcel(Request $request,CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal){
        ...
        if($request->hasFile('field_file')){
            ...
            if($request['field_file']->move($target_path,$excelfile)){
                ...
                $response = $this->dispatch(new ValidateExcelICCSJob($excelData));
    ...
    public function uploadfile(Request $request,CheckUploadedFileOnAwsORLocalService $checkUploadedFileOnAwsOrLocal){
       ...
       $previewPdf = array($request['previewPdf'],$request['previewWithoutBg']);
        ...
        $pdfData=array('studentDataOrg'=>$rowData1,'auth_site_id'=>$auth_site_id,'template_id'=>$template_id,'previewPdf'=>$previewPdf,'excelfile'=>$excelfile);
                $link = $this->dispatch(new PdfGenerateICCSJob($pdfData));
