    ...
    public function store(Request $request)
    {
        ...
        if(isset($_POST['qrcode'])){
            ...
            if($student_count > 0){
                    ...
                    if($transaction > 0 ){
                        ...
                        if($flag1 == 1){
                            ...
                            $html .= '<div class="col-xs-6">
                                        ...
                                        <div claass="row">
                                            <div class="col-xs-5"><label for="info3">Document Filename</label></div>
                                            <div class="col-xs-1"><label for="info3">:</label></div>
                                            <div class="col-xs-6"><a target="_blank" href="'.$path.'/'.$student["certificate_filename"].'">'.$student['certificate_filename'].'</a></div>
                                        </div><br><br>
                                        <div claass="row">
                                    ...
                                    if($flag1 == 1){
                                        ...
                                        $html .= '<div class="col-xs-6">
                                                    ...
                                                    <div claass="row">
                                                        <div class="col-xs-5"><label for="info3">Document Filename</label></div>
                                                        <div class="col-xs-1"><label for="info3">:</label></div>
                                                        <div class="col-xs-6"><a target="_blank" href="'.$path.'/'.$certificate_filename.'">'.$student['certificate_filename'].'</a></div>
                                                    </div><br><br>
                                                    <div claass="row">
                                                        <div class="col-xs-5"><label for="info3">Data</label></div>
                                                        <div class="col-xs-1"><label for="info3">:</label></div>
                            ...
                            if($payment_status == 'true'){
                                ...
                                $html .= '<div class="col-xs-6">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-5"><label for="info3">Certificate Filename</label></div>
                                                <div class="col-xs-1"><label for="info3">:</label></div>
                                                <div class="col-xs-6"><a target="_blank" href="'.$path.'/'.$student['certificate_filaname'].'">'.$student['certificate_filaname'].'</a></div>
                                            </div><hr>
                                            <div class="row">
                                                <div class="col-xs-12">
                ...
                $html .= '<div class="alert alert-danger">The QR code you scanned is not a Secured QR generated by this system. Kindly scan one of our Secured QR only.<a href="../dashboard.php"> Click here Scan Again</a></div></div></div>';
                $message = $html;
            }
