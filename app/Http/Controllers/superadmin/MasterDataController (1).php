    ...
    //
	  ...
	  public function index(Request $request){
       ...
       if($request->ajax()){
            ...
            $columnsQuery = [DB::raw('@rownum  := @rownum  + 1 AS rownum'),DB::raw('@site_url :=SUBSTRING_INDEX(sites_superdata.sites_name, ".", 1) AS site_url'),DB::raw('(template_number+inactive_template_number+custom_templates) AS template_number'),'active_documents','inactive_documents','total_verifier','total_scanned','last_genration_date'];
